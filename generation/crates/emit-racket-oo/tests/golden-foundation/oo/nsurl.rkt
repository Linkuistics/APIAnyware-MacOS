...
(provide NSURL)
(provide/contract
  [make-nsurl-init-with-data-representation-relative-to-url (c-> (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  [make-nsurl-init-with-string (c-> (or/c string? objc-object? cpointer?) any/c)]
  [make-nsurl-init-with-string-encoding-invalid-characters (c-> (or/c string? objc-object? cpointer?) boolean? any/c)]
  [make-nsurl-init-with-string-relative-to-url (c-> (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nsurl-bookmark-data-with-options-including-resource-values-for-keys-relative-to-url-error (c-> objc-object? exact-nonnegative-integer? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) (or/c cpointer? #f) any/c)]
  ...
  [nsurl-get-resource-value-for-key-error (c-> objc-object? (or/c cpointer? #f) (or/c string? objc-object? cpointer?) (or/c cpointer? #f) boolean?)]
  [nsurl-init-absolute-url-with-data-representation-relative-to-url (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  [nsurl-init-by-resolving-bookmark-data-options-relative-to-url-bookmark-data-is-stale-error (c-> objc-object? (or/c string? objc-object? cpointer?) exact-nonnegative-integer? (or/c string? objc-object? cpointer?) (or/c cpointer? #f) (or/c cpointer? #f) any/c)]
  [nsurl-init-file-url-with-file-system-representation-is-directory-relative-to-url (c-> objc-object? (or/c cpointer? #f) boolean? (or/c string? objc-object? cpointer?) any/c)]
  [nsurl-init-file-url-with-path (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  [nsurl-init-file-url-with-path-is-directory (c-> objc-object? (or/c string? objc-object? cpointer?) boolean? any/c)]
  [nsurl-init-file-url-with-path-is-directory-relative-to-url (c-> objc-object? (or/c string? objc-object? cpointer?) boolean? (or/c string? objc-object? cpointer?) any/c)]
  [nsurl-init-file-url-with-path-relative-to-url (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nsurl-remove-cached-resource-value-for-key! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsurl-resource-values-for-keys-error (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c cpointer? #f) any/c)]
  [nsurl-set-resource-value-for-key-error! (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) (or/c cpointer? #f) boolean?)]
  [nsurl-set-resource-values-error! (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c cpointer? #f) boolean?)]
  [nsurl-set-temporary-resource-value-for-key! (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsurl-url-by-resolving-alias-file-at-url-options-error (c-> (or/c string? objc-object? cpointer?) exact-nonnegative-integer? (or/c cpointer? #f) any/c)]
  [nsurl-url-by-resolving-bookmark-data-options-relative-to-url-bookmark-data-is-stale-error (c-> (or/c string? objc-object? cpointer?) exact-nonnegative-integer? (or/c string? objc-object? cpointer?) (or/c cpointer? #f) (or/c cpointer? #f) any/c)]
  [nsurl-url-with-data-representation-relative-to-url (c-> (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  [nsurl-url-with-string (c-> (or/c string? objc-object? cpointer?) any/c)]
  [nsurl-url-with-string-encoding-invalid-characters (c-> (or/c string? objc-object? cpointer?) boolean? any/c)]
  [nsurl-url-with-string-relative-to-url (c-> (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  [nsurl-absolute-url-with-data-representation-relative-to-url (c-> (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  [nsurl-bookmark-data-with-contents-of-url-error (c-> (or/c string? objc-object? cpointer?) (or/c cpointer? #f) any/c)]
  [nsurl-file-url-with-file-system-representation-is-directory-relative-to-url (c-> (or/c cpointer? #f) boolean? (or/c string? objc-object? cpointer?) any/c)]
  [nsurl-file-url-with-path (c-> (or/c string? objc-object? cpointer?) any/c)]
  [nsurl-file-url-with-path-is-directory (c-> (or/c string? objc-object? cpointer?) boolean? any/c)]
  [nsurl-file-url-with-path-is-directory-relative-to-url (c-> (or/c string? objc-object? cpointer?) boolean? (or/c string? objc-object? cpointer?) any/c)]
  [nsurl-file-url-with-path-relative-to-url (c-> (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  [nsurl-resource-values-for-keys-from-bookmark-data (c-> (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  [nsurl-write-bookmark-data-to-url-options-error (c-> (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) exact-nonnegative-integer? (or/c cpointer? #f) boolean?)]
  )

...
(provide/contract
  ...
  [nsuserdefaults-float-for-key (c-> objc-object? (or/c string? objc-object? #f) real?)]
  [nsuserdefaults-integer-for-key (c-> objc-object? (or/c string? objc-object? #f) exact-integer?)]
  [nsuserdefaults-object-for-key (c-> objc-object? (or/c string? objc-object? #f) any/c)]
  [nsuserdefaults-object-is-forced-for-key (c-> objc-object? (or/c string? objc-object? #f) boolean?)]
  [nsuserdefaults-object-is-forced-for-key-in-domain (c-> objc-object? (or/c string? objc-object? #f) (or/c string? objc-object? #f) boolean?)]
  [nsuserdefaults-persistent-domain-for-name (c-> objc-object? (or/c string? objc-object? #f) any/c)]
  [nsuserdefaults-register-defaults (c-> objc-object? (or/c string? objc-object? #f) void?)]
  [nsuserdefaults-remove-object-for-key! (c-> objc-object? (or/c string? objc-object? #f) void?)]
  [nsuserdefaults-remove-persistent-domain-for-name! (c-> objc-object? (or/c string? objc-object? #f) void?)]
  [nsuserdefaults-remove-suite-named! (c-> objc-object? (or/c string? objc-object? #f) void?)]
  [nsuserdefaults-remove-volatile-domain-for-name! (c-> objc-object? (or/c string? objc-object? #f) void?)]
  [nsuserdefaults-set-bool-for-key! (c-> objc-object? boolean? (or/c string? objc-object? #f) void?)]
  [nsuserdefaults-set-double-for-key! (c-> objc-object? real? (or/c string? objc-object? #f) void?)]
  [nsuserdefaults-set-float-for-key! (c-> objc-object? real? (or/c string? objc-object? #f) void?)]
  [nsuserdefaults-set-integer-for-key! (c-> objc-object? exact-integer? (or/c string? objc-object? #f) void?)]
  [nsuserdefaults-set-object-for-key! (c-> objc-object? (or/c string? objc-object? #f) (or/c string? objc-object? #f) void?)]
  [nsuserdefaults-set-persistent-domain-for-name! (c-> objc-object? (or/c string? objc-object? #f) (or/c string? objc-object? #f) void?)]

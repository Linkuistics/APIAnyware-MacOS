...
(provide/contract
  ...
  [nsdateformatter-set-am-symbol! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-pm-symbol (c-> objc-object? any/c)]
  [nsdateformatter-set-pm-symbol! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-calendar (c-> objc-object? any/c)]
  [nsdateformatter-set-calendar! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-date-format (c-> objc-object? any/c)]
  [nsdateformatter-set-date-format! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsdateformatter-set-default-date! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsdateformatter-set-era-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsdateformatter-set-gregorian-start-date! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsdateformatter-set-locale! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-long-era-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-long-era-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-month-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-month-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-quarter-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-quarter-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-short-month-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-short-month-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-short-quarter-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-short-quarter-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-short-standalone-month-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-short-standalone-month-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-short-standalone-quarter-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-short-standalone-quarter-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-short-standalone-weekday-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-short-standalone-weekday-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-short-weekday-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-short-weekday-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-standalone-month-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-standalone-month-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-standalone-quarter-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-standalone-quarter-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-standalone-weekday-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-standalone-weekday-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsdateformatter-set-time-zone! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-two-digit-start-date (c-> objc-object? any/c)]
  [nsdateformatter-set-two-digit-start-date! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-very-short-month-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-very-short-month-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-very-short-standalone-month-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-very-short-standalone-month-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-very-short-standalone-weekday-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-very-short-standalone-weekday-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-very-short-weekday-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-very-short-weekday-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-weekday-symbols (c-> objc-object? any/c)]
  [nsdateformatter-set-weekday-symbols! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-attributed-string-for-object-value-with-default-attributes (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  [nsdateformatter-date-from-string (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  [nsdateformatter-editing-string-for-object-value (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  [nsdateformatter-get-object-value-for-string-error-description (c-> objc-object? (or/c cpointer? #f) (or/c string? objc-object? cpointer?) (or/c cpointer? #f) boolean?)]
  [nsdateformatter-get-object-value-for-string-range-error (c-> objc-object? (or/c cpointer? #f) (or/c string? objc-object? cpointer?) (or/c cpointer? #f) (or/c cpointer? #f) boolean?)]
  [nsdateformatter-is-lenient (c-> objc-object? boolean?)]
  [nsdateformatter-is-partial-string-valid-new-editing-string-error-description (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c cpointer? #f) (or/c cpointer? #f) boolean?)]
  [nsdateformatter-is-partial-string-valid-proposed-selected-range-original-string-original-selected-range-error-description (c-> objc-object? (or/c cpointer? #f) (or/c cpointer? #f) (or/c string? objc-object? cpointer?) any/c (or/c cpointer? #f) boolean?)]
  [nsdateformatter-set-localized-date-format-from-template! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsdateformatter-string-for-object-value (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  [nsdateformatter-string-from-date (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  [nsdateformatter-date-format-from-template-options-locale (c-> (or/c string? objc-object? cpointer?) exact-nonnegative-integer? (or/c string? objc-object? cpointer?) any/c)]
  [nsdateformatter-localized-string-from-date-date-style-time-style (c-> (or/c string? objc-object? cpointer?) exact-nonnegative-integer? exact-nonnegative-integer? any/c)]
  )

...
(provide/contract
  [make-nswindowcontroller-init-with-coder (c-> any/c any/c)]
  [make-nswindowcontroller-init-with-window (c-> any/c any/c)]
  [make-nswindowcontroller-init-with-window-nib-name (c-> any/c any/c)]
  [make-nswindowcontroller-init-with-window-nib-name-owner (c-> any/c any/c any/c)]
  [make-nswindowcontroller-init-with-window-nib-path-owner (c-> any/c any/c any/c)]
  ...
  [nswindowcontroller-set-content-view-controller! (c-> objc-object? any/c void?)]
  [nswindowcontroller-document (c-> objc-object? any/c)]
  [nswindowcontroller-set-document! (c-> objc-object? any/c void?)]
  [nswindowcontroller-menu (c-> objc-object? any/c)]
  [nswindowcontroller-set-menu! (c-> objc-object? any/c void?)]
  [nswindowcontroller-next-responder (c-> objc-object? any/c)]
  [nswindowcontroller-set-next-responder! (c-> objc-object? any/c void?)]
  [nswindowcontroller-owner (c-> objc-object? any/c)]
  [nswindowcontroller-preview-representable-activity-items (c-> objc-object? any/c)]
  [nswindowcontroller-set-preview-representable-activity-items! (c-> objc-object? any/c void?)]
  ...
  [nswindowcontroller-set-touch-bar! (c-> objc-object? any/c void?)]
  [nswindowcontroller-undo-manager (c-> objc-object? any/c)]
  [nswindowcontroller-user-activity (c-> objc-object? any/c)]
  [nswindowcontroller-set-user-activity! (c-> objc-object? any/c void?)]
  [nswindowcontroller-window (c-> objc-object? any/c)]
  [nswindowcontroller-set-window! (c-> objc-object? any/c void?)]
  [nswindowcontroller-window-frame-autosave-name (c-> objc-object? any/c)]
  [nswindowcontroller-set-window-frame-autosave-name! (c-> objc-object? any/c void?)]
  ...
  [nswindowcontroller-begin-gesture-with-event! (c-> objc-object? any/c void?)]
  [nswindowcontroller-change-mode-with-event (c-> objc-object? any/c void?)]
  [nswindowcontroller-close! (c-> objc-object? void?)]
  [nswindowcontroller-context-menu-key-down (c-> objc-object? any/c void?)]
  [nswindowcontroller-cursor-update (c-> objc-object? any/c void?)]
  [nswindowcontroller-end-gesture-with-event! (c-> objc-object? any/c void?)]
  [nswindowcontroller-flags-changed (c-> objc-object? any/c void?)]
  [nswindowcontroller-flush-buffered-key-events (c-> objc-object? void?)]
  [nswindowcontroller-help-requested (c-> objc-object? any/c void?)]
  [nswindowcontroller-interpret-key-events (c-> objc-object? any/c void?)]
  [nswindowcontroller-is-window-loaded (c-> objc-object? boolean?)]
  [nswindowcontroller-key-down (c-> objc-object? any/c void?)]
  [nswindowcontroller-key-up (c-> objc-object? any/c void?)]
  [nswindowcontroller-load-window (c-> objc-object? void?)]
  [nswindowcontroller-magnify-with-event (c-> objc-object? any/c void?)]
  [nswindowcontroller-mouse-cancelled (c-> objc-object? any/c void?)]
  [nswindowcontroller-mouse-down (c-> objc-object? any/c void?)]
  [nswindowcontroller-mouse-dragged (c-> objc-object? any/c void?)]
  [nswindowcontroller-mouse-entered (c-> objc-object? any/c void?)]
  [nswindowcontroller-mouse-exited (c-> objc-object? any/c void?)]
  [nswindowcontroller-mouse-moved (c-> objc-object? any/c void?)]
  [nswindowcontroller-mouse-up (c-> objc-object? any/c void?)]
  [nswindowcontroller-no-responder-for (c-> objc-object? cpointer? void?)]
  [nswindowcontroller-other-mouse-down (c-> objc-object? any/c void?)]
  [nswindowcontroller-other-mouse-dragged (c-> objc-object? any/c void?)]
  [nswindowcontroller-other-mouse-up (c-> objc-object? any/c void?)]
  [nswindowcontroller-perform-key-equivalent! (c-> objc-object? any/c boolean?)]
  [nswindowcontroller-pressure-change-with-event (c-> objc-object? any/c void?)]
  [nswindowcontroller-quick-look-with-event (c-> objc-object? any/c void?)]
  [nswindowcontroller-resign-first-responder (c-> objc-object? boolean?)]
  [nswindowcontroller-right-mouse-down (c-> objc-object? any/c void?)]
  [nswindowcontroller-right-mouse-dragged (c-> objc-object? any/c void?)]
  [nswindowcontroller-right-mouse-up (c-> objc-object? any/c void?)]
  [nswindowcontroller-rotate-with-event (c-> objc-object? any/c void?)]
  [nswindowcontroller-scroll-wheel (c-> objc-object? any/c void?)]
  [nswindowcontroller-set-document-edited! (c-> objc-object? boolean? void?)]
  [nswindowcontroller-should-be-treated-as-ink-event (c-> objc-object? any/c boolean?)]
  [nswindowcontroller-show-context-help (c-> objc-object? any/c void?)]
  [nswindowcontroller-show-window (c-> objc-object? any/c void?)]
  [nswindowcontroller-smart-magnify-with-event (c-> objc-object? any/c void?)]
  [nswindowcontroller-supplemental-target-for-action-sender (c-> objc-object? cpointer? any/c any/c)]
  [nswindowcontroller-swipe-with-event (c-> objc-object? any/c void?)]
  [nswindowcontroller-synchronize-window-title-with-document-name (c-> objc-object? void?)]
  [nswindowcontroller-tablet-point (c-> objc-object? any/c void?)]
  [nswindowcontroller-tablet-proximity (c-> objc-object? any/c void?)]
  [nswindowcontroller-touches-began-with-event (c-> objc-object? any/c void?)]
  [nswindowcontroller-touches-cancelled-with-event (c-> objc-object? any/c void?)]
  [nswindowcontroller-touches-ended-with-event (c-> objc-object? any/c void?)]
  [nswindowcontroller-touches-moved-with-event (c-> objc-object? any/c void?)]
  [nswindowcontroller-try-to-perform-with (c-> objc-object? cpointer? any/c boolean?)]
  [nswindowcontroller-valid-requestor-for-send-type-return-type (c-> objc-object? any/c any/c any/c)]
  ...
  [nswindowcontroller-window-title-for-document-display-name (c-> objc-object? any/c any/c)]

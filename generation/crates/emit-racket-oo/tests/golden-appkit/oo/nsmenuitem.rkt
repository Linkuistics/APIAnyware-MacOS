...
(provide NSMenuItem)
(provide/contract
  [make-nsmenuitem-init-with-coder (c-> any/c any/c)]
  [make-nsmenuitem-init-with-title-action-key-equivalent (c-> any/c cpointer? any/c any/c)]
  ...
  [nsmenuitem-set-attributed-title! (c-> objc-object? any/c void?)]
  [nsmenuitem-badge (c-> objc-object? any/c)]
  [nsmenuitem-set-badge! (c-> objc-object? any/c void?)]
  ...
  [nsmenuitem-set-image! (c-> objc-object? any/c void?)]
  ...
  [nsmenuitem-set-key-equivalent! (c-> objc-object? any/c void?)]
  ...
  [nsmenuitem-set-menu! (c-> objc-object? any/c void?)]
  [nsmenuitem-mixed-state-image (c-> objc-object? any/c)]
  [nsmenuitem-set-mixed-state-image! (c-> objc-object? any/c void?)]
  [nsmenuitem-off-state-image (c-> objc-object? any/c)]
  [nsmenuitem-set-off-state-image! (c-> objc-object? any/c void?)]
  [nsmenuitem-on-state-image (c-> objc-object? any/c)]
  [nsmenuitem-set-on-state-image! (c-> objc-object? any/c void?)]
  [nsmenuitem-parent-item (c-> objc-object? any/c)]
  [nsmenuitem-represented-object (c-> objc-object? any/c)]
  [nsmenuitem-set-represented-object! (c-> objc-object? any/c void?)]
  ...
  [nsmenuitem-set-submenu! (c-> objc-object? any/c void?)]
  [nsmenuitem-subtitle (c-> objc-object? any/c)]
  [nsmenuitem-set-subtitle! (c-> objc-object? any/c void?)]
  ...
  [nsmenuitem-set-target! (c-> objc-object? any/c void?)]
  [nsmenuitem-title (c-> objc-object? any/c)]
  [nsmenuitem-set-title! (c-> objc-object? any/c void?)]
  [nsmenuitem-tool-tip (c-> objc-object? any/c)]
  [nsmenuitem-set-tool-tip! (c-> objc-object? any/c void?)]
  ...
  [nsmenuitem-set-view! (c-> objc-object? any/c void?)]
  ...
  [nsmenuitem-section-header-with-title (c-> any/c any/c)]
  )
...
(define (nsmenuitem-separator-item self)
  (tell #:type _bool (coerce-arg self) separatorItem))

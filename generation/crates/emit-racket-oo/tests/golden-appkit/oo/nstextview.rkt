...
(provide NSTextView)
(provide/contract
  [make-nstextview-init-with-coder (c-> any/c any/c)]
  [make-nstextview-init-with-frame (c-> any/c any/c)]
  [make-nstextview-init-with-frame-text-container (c-> any/c any/c any/c)]
  ...
  [nstextview-set-allowed-input-source-locales! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-background-color! (c-> objc-object? any/c void?)]
  [nstextview-background-filters (c-> objc-object? any/c)]
  [nstextview-set-background-filters! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-compositing-filter! (c-> objc-object? any/c void?)]
  [nstextview-constraints (c-> objc-object? any/c)]
  [nstextview-content-filters (c-> objc-object? any/c)]
  [nstextview-set-content-filters! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-default-paragraph-style! (c-> objc-object? any/c void?)]
  [nstextview-delegate (c-> objc-object? any/c)]
  [nstextview-set-delegate! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-font! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-gesture-recognizers! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-insertion-point-color! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-layer! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-link-text-attributes! (c-> objc-object? any/c void?)]
  [nstextview-marked-text-attributes (c-> objc-object? any/c)]
  [nstextview-set-marked-text-attributes! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-menu! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-next-key-view! (c-> objc-object? any/c void?)]
  [nstextview-next-responder (c-> objc-object? any/c)]
  [nstextview-set-next-responder! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-pressure-configuration! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-selected-ranges! (c-> objc-object? any/c void?)]
  [nstextview-selected-text-attributes (c-> objc-object? any/c)]
  [nstextview-set-selected-text-attributes! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-shadow! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-string! (c-> objc-object? any/c void?)]
  [nstextview-strongly-references-text-storage (c-> boolean?)]
  [nstextview-subviews (c-> objc-object? any/c)]
  [nstextview-set-subviews! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-text-color! (c-> objc-object? any/c void?)]
  [nstextview-text-container (c-> objc-object? any/c)]
  [nstextview-set-text-container! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-text-highlight-attributes! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-tool-tip! (c-> objc-object? any/c void?)]
  [nstextview-top-anchor (c-> objc-object? any/c)]
  [nstextview-touch-bar (c-> objc-object? any/c)]
  [nstextview-set-touch-bar! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-typing-attributes! (c-> objc-object? any/c void?)]
  [nstextview-undo-manager (c-> objc-object? any/c)]
  [nstextview-user-activity (c-> objc-object? any/c)]
  [nstextview-set-user-activity! (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-writing-tools-coordinator! (c-> objc-object? any/c void?)]
  [nstextview-rtfd-from-range (c-> objc-object? any/c any/c)]
  [nstextview-rtf-from-range (c-> objc-object? any/c any/c)]
  [nstextview-accepts-first-mouse (c-> objc-object? any/c boolean?)]
  [nstextview-add-subview! (c-> objc-object? any/c void?)]
  [nstextview-add-subview-positioned-relative-to! (c-> objc-object? any/c exact-nonnegative-integer? any/c void?)]
  [nstextview-add-tool-tip-rect-owner-user-data! (c-> objc-object? any/c any/c (or/c cpointer? #f) exact-integer?)]
  [nstextview-adjust-scroll (c-> objc-object? any/c any/c)]
  [nstextview-align-center (c-> objc-object? any/c void?)]
  [nstextview-align-justified (c-> objc-object? any/c void?)]
  [nstextview-align-left (c-> objc-object? any/c void?)]
  [nstextview-align-right (c-> objc-object? any/c void?)]
  [nstextview-ancestor-shared-with-view (c-> objc-object? any/c any/c)]
  [nstextview-autoscroll (c-> objc-object? any/c boolean?)]
  ...
  [nstextview-begin-gesture-with-event! (c-> objc-object? any/c void?)]
  [nstextview-bitmap-image-rep-for-caching-display-in-rect (c-> objc-object? any/c any/c)]
  [nstextview-cache-display-in-rect-to-bitmap-image-rep (c-> objc-object? any/c any/c void?)]
  [nstextview-center-scan-rect! (c-> objc-object? any/c any/c)]
  [nstextview-change-attributes (c-> objc-object? any/c void?)]
  [nstextview-change-color (c-> objc-object? any/c void?)]
  [nstextview-change-document-background-color (c-> objc-object? any/c void?)]
  [nstextview-change-font (c-> objc-object? any/c void?)]
  [nstextview-change-layout-orientation (c-> objc-object? any/c void?)]
  [nstextview-change-mode-with-event (c-> objc-object? any/c void?)]
  [nstextview-character-index-for-insertion-at-point (c-> objc-object? any/c exact-nonnegative-integer?)]
  [nstextview-check-spelling (c-> objc-object? any/c void?)]
  [nstextview-clicked-on-link-at-index (c-> objc-object? any/c exact-nonnegative-integer? void?)]
  [nstextview-context-menu-key-down (c-> objc-object? any/c void?)]
  [nstextview-convert-point-from-view (c-> objc-object? any/c any/c any/c)]
  [nstextview-convert-point-to-view (c-> objc-object? any/c any/c any/c)]
  ...
  [nstextview-convert-rect-from-view (c-> objc-object? any/c any/c any/c)]
  [nstextview-convert-rect-to-view (c-> objc-object? any/c any/c any/c)]
  ...
  [nstextview-convert-size-from-view (c-> objc-object? any/c any/c any/c)]
  [nstextview-convert-size-to-view (c-> objc-object? any/c any/c any/c)]
  ...
  [nstextview-copy (c-> objc-object? any/c void?)]
  [nstextview-copy-font (c-> objc-object? any/c void?)]
  [nstextview-copy-ruler (c-> objc-object? any/c void?)]
  [nstextview-cursor-update (c-> objc-object? any/c void?)]
  [nstextview-cut (c-> objc-object? any/c void?)]
  [nstextview-delete (c-> objc-object? any/c void?)]
  [nstextview-did-add-subview (c-> objc-object? any/c void?)]
  [nstextview-did-close-menu-with-event (c-> objc-object? any/c any/c void?)]
  ...
  [nstextview-display-rect-ignoring-opacity-in-context! (c-> objc-object? any/c any/c void?)]
  [nstextview-draw-insertion-point-in-rect-color-turned-on (c-> objc-object? any/c any/c boolean? void?)]
  [nstextview-draw-rect (c-> objc-object? any/c void?)]
  [nstextview-draw-view-background-in-rect (c-> objc-object? any/c void?)]
  [nstextview-end-gesture-with-event! (c-> objc-object? any/c void?)]
  [nstextview-flags-changed (c-> objc-object? any/c void?)]
  ...
  [nstextview-key-down (c-> objc-object? any/c void?)]
  [nstextview-key-up (c-> objc-object? any/c void?)]
  [nstextview-layout (c-> objc-object? void?)]
  [nstextview-layout-subtree-if-needed (c-> objc-object? void?)]
  [nstextview-loosen-kerning (c-> objc-object? any/c void?)]
  [nstextview-lower-baseline (c-> objc-object? any/c void?)]
  [nstextview-magnify-with-event (c-> objc-object? any/c void?)]
  [nstextview-make-backing-layer (c-> objc-object? any/c)]
  [nstextview-menu-for-event (c-> objc-object? any/c any/c)]
  [nstextview-mouse-in-rect (c-> objc-object? any/c any/c boolean?)]
  [nstextview-mouse-cancelled (c-> objc-object? any/c void?)]
  [nstextview-mouse-down (c-> objc-object? any/c void?)]
  [nstextview-mouse-dragged (c-> objc-object? any/c void?)]
  [nstextview-mouse-entered (c-> objc-object? any/c void?)]
  [nstextview-mouse-exited (c-> objc-object? any/c void?)]
  [nstextview-mouse-moved (c-> objc-object? any/c void?)]
  [nstextview-mouse-up (c-> objc-object? any/c void?)]
  [nstextview-needs-to-draw-rect (c-> objc-object? any/c boolean?)]
  [nstextview-no-responder-for (c-> objc-object? cpointer? void?)]
  [nstextview-order-front-link-panel! (c-> objc-object? any/c void?)]
  [nstextview-order-front-list-panel! (c-> objc-object? any/c void?)]
  [nstextview-order-front-spacing-panel! (c-> objc-object? any/c void?)]
  [nstextview-order-front-table-panel! (c-> objc-object? any/c void?)]
  [nstextview-other-mouse-down (c-> objc-object? any/c void?)]
  [nstextview-other-mouse-dragged (c-> objc-object? any/c void?)]
  [nstextview-other-mouse-up (c-> objc-object? any/c void?)]
  [nstextview-outline (c-> objc-object? any/c void?)]
  [nstextview-paste (c-> objc-object? any/c void?)]
  [nstextview-paste-font (c-> objc-object? any/c void?)]
  [nstextview-paste-ruler (c-> objc-object? any/c void?)]
  [nstextview-perform-find-panel-action! (c-> objc-object? any/c void?)]
  [nstextview-perform-key-equivalent! (c-> objc-object? any/c boolean?)]
  [nstextview-perform-validated-replacement-in-range-with-attributed-string! (c-> objc-object? any/c any/c boolean?)]
  [nstextview-prepare-content-in-rect (c-> objc-object? any/c void?)]
  [nstextview-prepare-for-reuse (c-> objc-object? void?)]
  [nstextview-pressure-change-with-event (c-> objc-object? any/c void?)]
  [nstextview-quick-look-with-event (c-> objc-object? any/c void?)]
  [nstextview-raise-baseline (c-> objc-object? any/c void?)]
  [nstextview-read-rtfd-from-file (c-> objc-object? any/c boolean?)]
  ...
  [nstextview-replace-characters-in-range-with-rtf! (c-> objc-object? any/c any/c void?)]
  [nstextview-replace-characters-in-range-with-rtfd! (c-> objc-object? any/c any/c void?)]
  [nstextview-replace-characters-in-range-with-string! (c-> objc-object? any/c any/c void?)]
  [nstextview-replace-subview-with! (c-> objc-object? any/c any/c void?)]
  [nstextview-replace-text-container! (c-> objc-object? any/c void?)]
  ...
  [nstextview-right-mouse-down (c-> objc-object? any/c void?)]
  [nstextview-right-mouse-dragged (c-> objc-object? any/c void?)]
  [nstextview-right-mouse-up (c-> objc-object? any/c void?)]
  [nstextview-rotate-by-angle (c-> objc-object? real? void?)]
  [nstextview-rotate-with-event (c-> objc-object? any/c void?)]
  [nstextview-ruler-view-did-add-marker (c-> objc-object? any/c any/c void?)]
  [nstextview-ruler-view-did-move-marker (c-> objc-object? any/c any/c void?)]
  [nstextview-ruler-view-did-remove-marker (c-> objc-object? any/c any/c void?)]
  [nstextview-ruler-view-handle-mouse-down (c-> objc-object? any/c any/c void?)]
  [nstextview-ruler-view-should-add-marker (c-> objc-object? any/c any/c boolean?)]
  [nstextview-ruler-view-should-move-marker (c-> objc-object? any/c any/c boolean?)]
  [nstextview-ruler-view-should-remove-marker (c-> objc-object? any/c any/c boolean?)]
  [nstextview-ruler-view-will-add-marker-at-location (c-> objc-object? any/c any/c real? real?)]
  [nstextview-ruler-view-will-move-marker-to-location (c-> objc-object? any/c any/c real? real?)]
  ...
  [nstextview-scroll-wheel (c-> objc-object? any/c void?)]
  [nstextview-select-all (c-> objc-object? any/c void?)]
  ...
  [nstextview-set-font-range! (c-> objc-object? any/c any/c void?)]
  ...
  [nstextview-set-text-color-range! (c-> objc-object? any/c any/c void?)]
  [nstextview-should-be-treated-as-ink-event (c-> objc-object? any/c boolean?)]
  [nstextview-should-delay-window-ordering-for-event (c-> objc-object? any/c boolean?)]
  [nstextview-show-context-help (c-> objc-object? any/c void?)]
  [nstextview-show-guess-panel (c-> objc-object? any/c void?)]
  [nstextview-size-to-fit (c-> objc-object? void?)]
  [nstextview-smart-magnify-with-event (c-> objc-object? any/c void?)]
  [nstextview-sort-subviews-using-function-context (c-> objc-object? (or/c cpointer? #f) (or/c cpointer? #f) void?)]
  [nstextview-start-speaking (c-> objc-object? any/c void?)]
  [nstextview-stop-speaking (c-> objc-object? any/c void?)]
  [nstextview-subscript (c-> objc-object? any/c void?)]
  [nstextview-superscript (c-> objc-object? any/c void?)]
  [nstextview-supplemental-target-for-action-sender (c-> objc-object? cpointer? any/c any/c)]
  [nstextview-swipe-with-event (c-> objc-object? any/c void?)]
  [nstextview-tablet-point (c-> objc-object? any/c void?)]
  [nstextview-tablet-proximity (c-> objc-object? any/c void?)]
  [nstextview-tighten-kerning (c-> objc-object? any/c void?)]
  [nstextview-toggle-ruler! (c-> objc-object? any/c void?)]
  [nstextview-touches-began-with-event (c-> objc-object? any/c void?)]
  [nstextview-touches-cancelled-with-event (c-> objc-object? any/c void?)]
  [nstextview-touches-ended-with-event (c-> objc-object? any/c void?)]
  [nstextview-touches-moved-with-event (c-> objc-object? any/c void?)]
  ...
  [nstextview-try-to-perform-with (c-> objc-object? cpointer? any/c boolean?)]
  [nstextview-turn-off-kerning (c-> objc-object? any/c void?)]
  [nstextview-turn-off-ligatures (c-> objc-object? any/c void?)]
  [nstextview-underline (c-> objc-object? any/c void?)]
  [nstextview-unscript (c-> objc-object? any/c void?)]
  ...
  [nstextview-use-all-ligatures (c-> objc-object? any/c void?)]
  [nstextview-use-standard-kerning (c-> objc-object? any/c void?)]
  [nstextview-use-standard-ligatures (c-> objc-object? any/c void?)]
  [nstextview-valid-requestor-for-send-type-return-type (c-> objc-object? any/c any/c any/c)]
  ...
  [nstextview-view-will-move-to-superview (c-> objc-object? any/c void?)]
  [nstextview-view-will-move-to-window (c-> objc-object? any/c void?)]
  ...
  [nstextview-will-open-menu-with-event (c-> objc-object? any/c any/c void?)]
  [nstextview-will-remove-subview (c-> objc-object? any/c void?)]
  [nstextview-write-rtfd-to-file-atomically (c-> objc-object? any/c boolean? boolean?)]

...
(provide/contract
  ...
  [nstextview-ancestor-shared-with-view (c-> objc-object? (or/c string? objc-object? #f) any/c)]
  ...
  [nstextview-menu-for-event (c-> objc-object? (or/c string? objc-object? #f) any/c)]

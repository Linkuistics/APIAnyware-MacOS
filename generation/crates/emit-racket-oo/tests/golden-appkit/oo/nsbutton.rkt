...
(provide/contract
  ...
  [nsbutton-ancestor-shared-with-view (c-> objc-object? (or/c string? objc-object? #f) any/c)]
  ...
  [nsbutton-menu-for-event (c-> objc-object? (or/c string? objc-object? #f) any/c)]
...
(define (nsbutton-set-action! self value)
  (_msg-39 (coerce-arg self) (sel_registerName "setAction:") (sel_registerName value)))
...
(define (nsbutton-send-action-to self action target)
  (_msg-40 (coerce-arg self) (sel_registerName "sendAction:to:") (sel_registerName action) (coerce-arg target)))

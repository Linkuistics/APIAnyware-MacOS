...
(provide/contract
  ...
  [nsview-ancestor-shared-with-view (c-> objc-object? (or/c string? objc-object? #f) any/c)]
  ...
  [nsview-menu-for-event (c-> objc-object? (or/c string? objc-object? #f) any/c)]
...
(define (nsview-no-responder-for self event-selector)
  (_msg-30 (coerce-arg self) (sel_registerName "noResponderFor:") (sel_registerName event-selector)))
...
(define (nsview-supplemental-target-for-action-sender self action sender)
  (wrap-objc-object
   (_msg-32 (coerce-arg self) (sel_registerName "supplementalTargetForAction:sender:") (sel_registerName action) (coerce-arg sender))
   ))
...
(define (nsview-try-to-perform-with self action object)
  (_msg-31 (coerce-arg self) (sel_registerName "tryToPerform:with:") (sel_registerName action) (coerce-arg object)))

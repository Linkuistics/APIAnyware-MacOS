...
(define (nsview-set-layer-contents-placement! self value)
  (_msg-30 (coerce-arg self) (sel_registerName "setLayerContentsPlacement:") value))
...
(define (nsview-set-layer-contents-redraw-policy! self value)
  (_msg-30 (coerce-arg self) (sel_registerName "setLayerContentsRedrawPolicy:") value))
...
(define (nsview-set-user-interface-layout-direction! self value)
  (_msg-30 (coerce-arg self) (sel_registerName "setUserInterfaceLayoutDirection:") value))
...
(define (nsview-get-rects-being-drawn-count self rects count)
  (_msg-34 (coerce-arg self) (sel_registerName "getRectsBeingDrawn:count:") rects count))
(define (nsview-get-rects-exposed-during-live-resize-count self exposed-rects count)
  (_msg-34 (coerce-arg self) (sel_registerName "getRectsExposedDuringLiveResize:count:") exposed-rects count))
...
(define (nsview-no-responder-for self event-selector)
  (_msg-31 (coerce-arg self) (sel_registerName "noResponderFor:") (sel_registerName event-selector)))
...
(define (nsview-remove-tool-tip! self tag)
  (_msg-30 (coerce-arg self) (sel_registerName "removeToolTip:") tag))
...
(define (nsview-sort-subviews-using-function-context self compare context)
  (_msg-34 (coerce-arg self) (sel_registerName "sortSubviewsUsingFunction:context:") compare context))
(define (nsview-supplemental-target-for-action-sender self action sender)
  (wrap-objc-object
   (_msg-33 (coerce-arg self) (sel_registerName "supplementalTargetForAction:sender:") (sel_registerName action) (coerce-arg sender))
   ))
...
(define (nsview-try-to-perform-with self action object)
  (_msg-32 (coerce-arg self) (sel_registerName "tryToPerform:with:") (sel_registerName action) (coerce-arg object)))
...
(define (nsview-view-with-tag self tag)
  (wrap-objc-object
   (_msg-29 (coerce-arg self) (sel_registerName "viewWithTag:") tag)
   ))
(define (nsview-wants-forwarded-scroll-events-for-axis self axis)
  (_msg-28 (coerce-arg self) (sel_registerName "wantsForwardedScrollEventsForAxis:") axis))
(define (nsview-wants-scroll-events-for-swipe-tracking-on-axis self axis)
  (_msg-28 (coerce-arg self) (sel_registerName "wantsScrollEventsForSwipeTrackingOnAxis:") axis))

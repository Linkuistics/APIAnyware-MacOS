...
(provide NSView)
(provide/contract
  [make-nsview-init-with-coder (c-> any/c any/c)]
  ...
  [nsview-set-background-filters! (c-> objc-object? any/c void?)]
  ...
  [nsview-set-compositing-filter! (c-> objc-object? any/c void?)]
  [nsview-constraints (c-> objc-object? any/c)]
  [nsview-content-filters (c-> objc-object? any/c)]
  [nsview-set-content-filters! (c-> objc-object? any/c void?)]
  ...
  [nsview-set-gesture-recognizers! (c-> objc-object? any/c void?)]
  ...
  [nsview-set-layer! (c-> objc-object? any/c void?)]
  ...
  [nsview-set-menu! (c-> objc-object? any/c void?)]
  ...
  [nsview-set-next-key-view! (c-> objc-object? any/c void?)]
  [nsview-next-responder (c-> objc-object? any/c)]
  [nsview-set-next-responder! (c-> objc-object? any/c void?)]
  ...
  [nsview-set-pressure-configuration! (c-> objc-object? any/c void?)]
  ...
  [nsview-set-user-activity! (c-> objc-object? any/c void?)]
  ...
  [nsview-set-writing-tools-coordinator! (c-> objc-object? any/c void?)]
  [nsview-accepts-first-mouse (c-> objc-object? any/c boolean?)]
  [nsview-add-subview! (c-> objc-object? any/c void?)]
  [nsview-add-subview-positioned-relative-to! (c-> objc-object? any/c exact-nonnegative-integer? any/c void?)]
  [nsview-add-tool-tip-rect-owner-user-data! (c-> objc-object? any/c any/c (or/c cpointer? #f) exact-integer?)]
  [nsview-adjust-scroll (c-> objc-object? any/c any/c)]
  [nsview-ancestor-shared-with-view (c-> objc-object? any/c any/c)]
  [nsview-autoscroll (c-> objc-object? any/c boolean?)]
  ...
  [nsview-begin-gesture-with-event! (c-> objc-object? any/c void?)]
  [nsview-bitmap-image-rep-for-caching-display-in-rect (c-> objc-object? any/c any/c)]
  [nsview-cache-display-in-rect-to-bitmap-image-rep (c-> objc-object? any/c any/c void?)]
  [nsview-center-scan-rect! (c-> objc-object? any/c any/c)]
  [nsview-change-mode-with-event (c-> objc-object? any/c void?)]
  [nsview-context-menu-key-down (c-> objc-object? any/c void?)]
  [nsview-convert-point-from-view (c-> objc-object? any/c any/c any/c)]
  [nsview-convert-point-to-view (c-> objc-object? any/c any/c any/c)]
  ...
  [nsview-convert-rect-from-view (c-> objc-object? any/c any/c any/c)]
  [nsview-convert-rect-to-view (c-> objc-object? any/c any/c any/c)]
  ...
  [nsview-convert-size-from-view (c-> objc-object? any/c any/c any/c)]
  [nsview-convert-size-to-view (c-> objc-object? any/c any/c any/c)]
  ...
  [nsview-cursor-update (c-> objc-object? any/c void?)]
  [nsview-did-add-subview (c-> objc-object? any/c void?)]
  [nsview-did-close-menu-with-event (c-> objc-object? any/c any/c void?)]
  ...
  [nsview-display-rect-ignoring-opacity-in-context! (c-> objc-object? any/c any/c void?)]
  [nsview-draw-rect (c-> objc-object? any/c void?)]
  [nsview-end-gesture-with-event! (c-> objc-object? any/c void?)]
  [nsview-flags-changed (c-> objc-object? any/c void?)]
  ...
  [nsview-help-requested (c-> objc-object? any/c void?)]
  [nsview-hit-test (c-> objc-object? any/c any/c)]
  [nsview-interpret-key-events (c-> objc-object? any/c void?)]
  [nsview-is-descendant-of (c-> objc-object? any/c boolean?)]
  ...
  [nsview-key-down (c-> objc-object? any/c void?)]
  [nsview-key-up (c-> objc-object? any/c void?)]
  [nsview-layout (c-> objc-object? void?)]
  [nsview-layout-subtree-if-needed (c-> objc-object? void?)]
  [nsview-magnify-with-event (c-> objc-object? any/c void?)]
  [nsview-make-backing-layer (c-> objc-object? any/c)]
  [nsview-menu-for-event (c-> objc-object? any/c any/c)]
  [nsview-mouse-in-rect (c-> objc-object? any/c any/c boolean?)]
  [nsview-mouse-cancelled (c-> objc-object? any/c void?)]
  [nsview-mouse-down (c-> objc-object? any/c void?)]
  [nsview-mouse-dragged (c-> objc-object? any/c void?)]
  [nsview-mouse-entered (c-> objc-object? any/c void?)]
  [nsview-mouse-exited (c-> objc-object? any/c void?)]
  [nsview-mouse-moved (c-> objc-object? any/c void?)]
  [nsview-mouse-up (c-> objc-object? any/c void?)]
  [nsview-needs-to-draw-rect (c-> objc-object? any/c boolean?)]
  [nsview-no-responder-for (c-> objc-object? cpointer? void?)]
  [nsview-other-mouse-down (c-> objc-object? any/c void?)]
  [nsview-other-mouse-dragged (c-> objc-object? any/c void?)]
  [nsview-other-mouse-up (c-> objc-object? any/c void?)]
  [nsview-perform-key-equivalent! (c-> objc-object? any/c boolean?)]
  [nsview-prepare-content-in-rect (c-> objc-object? any/c void?)]
  [nsview-prepare-for-reuse (c-> objc-object? void?)]
  [nsview-pressure-change-with-event (c-> objc-object? any/c void?)]
  [nsview-quick-look-with-event (c-> objc-object? any/c void?)]
  ...
  [nsview-replace-subview-with! (c-> objc-object? any/c any/c void?)]
  ...
  [nsview-right-mouse-down (c-> objc-object? any/c void?)]
  [nsview-right-mouse-dragged (c-> objc-object? any/c void?)]
  [nsview-right-mouse-up (c-> objc-object? any/c void?)]
  [nsview-rotate-by-angle (c-> objc-object? real? void?)]
  [nsview-rotate-with-event (c-> objc-object? any/c void?)]
  ...
  [nsview-scroll-wheel (c-> objc-object? any/c void?)]
  ...
  [nsview-should-be-treated-as-ink-event (c-> objc-object? any/c boolean?)]
  [nsview-should-delay-window-ordering-for-event (c-> objc-object? any/c boolean?)]
  [nsview-show-context-help (c-> objc-object? any/c void?)]
  [nsview-smart-magnify-with-event (c-> objc-object? any/c void?)]
  [nsview-sort-subviews-using-function-context (c-> objc-object? (or/c cpointer? #f) (or/c cpointer? #f) void?)]
  [nsview-supplemental-target-for-action-sender (c-> objc-object? cpointer? any/c any/c)]
  [nsview-swipe-with-event (c-> objc-object? any/c void?)]
  [nsview-tablet-point (c-> objc-object? any/c void?)]
  [nsview-tablet-proximity (c-> objc-object? any/c void?)]
  [nsview-touches-began-with-event (c-> objc-object? any/c void?)]
  [nsview-touches-cancelled-with-event (c-> objc-object? any/c void?)]
  [nsview-touches-ended-with-event (c-> objc-object? any/c void?)]
  [nsview-touches-moved-with-event (c-> objc-object? any/c void?)]
  ...
  [nsview-try-to-perform-with (c-> objc-object? cpointer? any/c boolean?)]
  [nsview-update-layer (c-> objc-object? void?)]
  [nsview-valid-requestor-for-send-type-return-type (c-> objc-object? any/c any/c any/c)]
  ...
  [nsview-view-will-move-to-superview (c-> objc-object? any/c void?)]
  [nsview-view-will-move-to-window (c-> objc-object? any/c void?)]
  ...
  [nsview-will-open-menu-with-event (c-> objc-object? any/c any/c void?)]
  [nsview-will-remove-subview (c-> objc-object? any/c void?)]

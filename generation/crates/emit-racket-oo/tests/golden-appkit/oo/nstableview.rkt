...
(provide/contract
  ...
  [nstableview-ancestor-shared-with-view (c-> objc-object? (or/c string? objc-object? #f) any/c)]
  ...
  [nstableview-drag-image-for-rows-with-indexes-table-columns-event-offset (c-> objc-object? (or/c string? objc-object? #f) (or/c string? objc-object? #f) (or/c string? objc-object? #f) (or/c cpointer? #f) any/c)]
  ...
  [nstableview-indicator-image-in-table-column (c-> objc-object? (or/c string? objc-object? #f) any/c)]
  ...
  [nstableview-menu-for-event (c-> objc-object? (or/c string? objc-object? #f) any/c)]
  ...
  [nstableview-table-column-with-identifier (c-> objc-object? (or/c string? objc-object? #f) any/c)]

...
(provide NSTableView)
(provide/contract
  [make-nstableview-init-with-coder (c-> any/c any/c)]
  ...
  [nstableview-set-attributed-string-value! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-autosave-name! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-background-color! (c-> objc-object? any/c void?)]
  [nstableview-background-filters (c-> objc-object? any/c)]
  [nstableview-set-background-filters! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-cell! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-compositing-filter! (c-> objc-object? any/c void?)]
  [nstableview-constraints (c-> objc-object? any/c)]
  [nstableview-content-filters (c-> objc-object? any/c)]
  [nstableview-set-content-filters! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-corner-view! (c-> objc-object? any/c void?)]
  [nstableview-data-source (c-> objc-object? any/c)]
  [nstableview-set-data-source! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-delegate! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-font! (c-> objc-object? any/c void?)]
  [nstableview-formatter (c-> objc-object? any/c)]
  [nstableview-set-formatter! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-gesture-recognizers! (c-> objc-object? any/c void?)]
  [nstableview-grid-color (c-> objc-object? any/c)]
  [nstableview-set-grid-color! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-header-view! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-highlighted-table-column! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-layer! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-menu! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-next-key-view! (c-> objc-object? any/c void?)]
  [nstableview-next-responder (c-> objc-object? any/c)]
  [nstableview-set-next-responder! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-object-value! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-pressure-configuration! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-shadow! (c-> objc-object? any/c void?)]
  [nstableview-sort-descriptors (c-> objc-object? any/c)]
  [nstableview-set-sort-descriptors! (c-> objc-object? any/c void?)]
  [nstableview-string-value (c-> objc-object? any/c)]
  [nstableview-set-string-value! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-subviews! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-target! (c-> objc-object? any/c void?)]
  [nstableview-tool-tip (c-> objc-object? any/c)]
  [nstableview-set-tool-tip! (c-> objc-object? any/c void?)]
  [nstableview-top-anchor (c-> objc-object? any/c)]
  [nstableview-touch-bar (c-> objc-object? any/c)]
  [nstableview-set-touch-bar! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-user-activity! (c-> objc-object? any/c void?)]
  ...
  [nstableview-set-writing-tools-coordinator! (c-> objc-object? any/c void?)]
  [nstableview-accepts-first-mouse (c-> objc-object? any/c boolean?)]
  [nstableview-add-subview! (c-> objc-object? any/c void?)]
  [nstableview-add-subview-positioned-relative-to! (c-> objc-object? any/c exact-nonnegative-integer? any/c void?)]
  [nstableview-add-table-column! (c-> objc-object? any/c void?)]
  [nstableview-add-tool-tip-rect-owner-user-data! (c-> objc-object? any/c any/c (or/c cpointer? #f) exact-integer?)]
  [nstableview-adjust-scroll (c-> objc-object? any/c any/c)]
  [nstableview-ancestor-shared-with-view (c-> objc-object? any/c any/c)]
  [nstableview-autoscroll (c-> objc-object? any/c boolean?)]
  ...
  [nstableview-begin-gesture-with-event! (c-> objc-object? any/c void?)]
  ...
  [nstableview-cache-display-in-rect-to-bitmap-image-rep (c-> objc-object? any/c any/c void?)]
  [nstableview-can-drag-rows-with-indexes-at-point (c-> objc-object? any/c any/c boolean?)]
  [nstableview-center-scan-rect! (c-> objc-object? any/c any/c)]
  [nstableview-change-mode-with-event (c-> objc-object? any/c void?)]
  [nstableview-column-at-point (c-> objc-object? any/c exact-integer?)]
  [nstableview-column-for-view (c-> objc-object? any/c exact-integer?)]
  [nstableview-column-indexes-in-rect (c-> objc-object? any/c any/c)]
  [nstableview-column-with-identifier (c-> objc-object? any/c exact-integer?)]
  [nstableview-context-menu-key-down (c-> objc-object? any/c void?)]
  [nstableview-convert-point-from-view (c-> objc-object? any/c any/c any/c)]
  [nstableview-convert-point-to-view (c-> objc-object? any/c any/c any/c)]
  ...
  [nstableview-convert-rect-from-view (c-> objc-object? any/c any/c any/c)]
  [nstableview-convert-rect-to-view (c-> objc-object? any/c any/c any/c)]
  ...
  [nstableview-convert-size-from-view (c-> objc-object? any/c any/c any/c)]
  [nstableview-convert-size-to-view (c-> objc-object? any/c any/c any/c)]
  ...
  [nstableview-cursor-update (c-> objc-object? any/c void?)]
  [nstableview-deselect-all (c-> objc-object? any/c void?)]
  [nstableview-deselect-column (c-> objc-object? exact-integer? void?)]
  [nstableview-deselect-row (c-> objc-object? exact-integer? void?)]
  [nstableview-did-add-row-view-for-row (c-> objc-object? any/c exact-integer? void?)]
  [nstableview-did-add-subview (c-> objc-object? any/c void?)]
  [nstableview-did-close-menu-with-event (c-> objc-object? any/c any/c void?)]
  [nstableview-did-remove-row-view-for-row (c-> objc-object? any/c exact-integer? void?)]
  ...
  [nstableview-display-rect-ignoring-opacity-in-context! (c-> objc-object? any/c any/c void?)]
  [nstableview-drag-image-for-rows-with-indexes-table-columns-event-offset (c-> objc-object? any/c any/c any/c (or/c cpointer? #f) any/c)]
  ...
  [nstableview-draw-with-expansion-frame-in-view (c-> objc-object? any/c any/c void?)]
  [nstableview-edit-column-row-with-event-select (c-> objc-object? exact-integer? exact-integer? any/c boolean? void?)]
  [nstableview-end-gesture-with-event! (c-> objc-object? any/c void?)]
  ...
  [nstableview-flags-changed (c-> objc-object? any/c void?)]
  ...
  [nstableview-help-requested (c-> objc-object? any/c void?)]
  [nstableview-hide-rows-at-indexes-with-animation (c-> objc-object? any/c exact-nonnegative-integer? void?)]
  [nstableview-highlight-selection-in-clip-rect (c-> objc-object? any/c void?)]
  [nstableview-hit-test (c-> objc-object? any/c any/c)]
  [nstableview-indicator-image-in-table-column (c-> objc-object? any/c any/c)]
  [nstableview-insert-rows-at-indexes-with-animation! (c-> objc-object? any/c exact-nonnegative-integer? void?)]
  [nstableview-interpret-key-events (c-> objc-object? any/c void?)]
  [nstableview-is-column-selected (c-> objc-object? exact-integer? boolean?)]
  [nstableview-is-continuous (c-> objc-object? boolean?)]
  [nstableview-is-descendant-of (c-> objc-object? any/c boolean?)]
  ...
  [nstableview-key-down (c-> objc-object? any/c void?)]
  [nstableview-key-up (c-> objc-object? any/c void?)]
  [nstableview-layout (c-> objc-object? void?)]
  [nstableview-layout-subtree-if-needed (c-> objc-object? void?)]
  [nstableview-magnify-with-event (c-> objc-object? any/c void?)]
  [nstableview-make-backing-layer (c-> objc-object? any/c)]
  [nstableview-make-view-with-identifier-owner (c-> objc-object? any/c any/c any/c)]
  [nstableview-menu-for-event (c-> objc-object? any/c any/c)]
  [nstableview-mouse-in-rect (c-> objc-object? any/c any/c boolean?)]
  [nstableview-mouse-cancelled (c-> objc-object? any/c void?)]
  [nstableview-mouse-down (c-> objc-object? any/c void?)]
  [nstableview-mouse-dragged (c-> objc-object? any/c void?)]
  [nstableview-mouse-entered (c-> objc-object? any/c void?)]
  [nstableview-mouse-exited (c-> objc-object? any/c void?)]
  [nstableview-mouse-moved (c-> objc-object? any/c void?)]
  [nstableview-mouse-up (c-> objc-object? any/c void?)]
  ...
  [nstableview-note-height-of-rows-with-indexes-changed (c-> objc-object? any/c void?)]
  [nstableview-note-number-of-rows-changed (c-> objc-object? void?)]
  [nstableview-other-mouse-down (c-> objc-object? any/c void?)]
  [nstableview-other-mouse-dragged (c-> objc-object? any/c void?)]
  [nstableview-other-mouse-up (c-> objc-object? any/c void?)]
  [nstableview-perform-click! (c-> objc-object? any/c void?)]
  [nstableview-perform-key-equivalent! (c-> objc-object? any/c boolean?)]
  [nstableview-prepare-content-in-rect (c-> objc-object? any/c void?)]
  [nstableview-prepare-for-reuse (c-> objc-object? void?)]
  [nstableview-pressure-change-with-event (c-> objc-object? any/c void?)]
  [nstableview-quick-look-with-event (c-> objc-object? any/c void?)]
  ...
  [nstableview-register-nib-for-identifier (c-> objc-object? any/c any/c void?)]
  [nstableview-reload-data (c-> objc-object? void?)]
  [nstableview-reload-data-for-row-indexes-column-indexes (c-> objc-object? any/c any/c void?)]
  ...
  [nstableview-remove-rows-at-indexes-with-animation! (c-> objc-object? any/c exact-nonnegative-integer? void?)]
  [nstableview-remove-table-column! (c-> objc-object? any/c void?)]
  [nstableview-remove-tool-tip! (c-> objc-object? exact-integer? void?)]
  [nstableview-replace-subview-with! (c-> objc-object? any/c any/c void?)]
  ...
  [nstableview-right-mouse-down (c-> objc-object? any/c void?)]
  [nstableview-right-mouse-dragged (c-> objc-object? any/c void?)]
  [nstableview-right-mouse-up (c-> objc-object? any/c void?)]
  [nstableview-rotate-by-angle (c-> objc-object? real? void?)]
  [nstableview-rotate-with-event (c-> objc-object? any/c void?)]
  [nstableview-row-at-point (c-> objc-object? any/c exact-integer?)]
  [nstableview-row-for-view (c-> objc-object? any/c exact-integer?)]
  ...
  [nstableview-scroll-wheel (c-> objc-object? any/c void?)]
  [nstableview-select-all (c-> objc-object? any/c void?)]
  [nstableview-select-column-indexes-by-extending-selection (c-> objc-object? any/c boolean? void?)]
  [nstableview-select-row-indexes-by-extending-selection (c-> objc-object? any/c boolean? void?)]
  [nstableview-send-action-to (c-> objc-object? cpointer? any/c boolean?)]
  ...
  [nstableview-set-indicator-image-in-table-column! (c-> objc-object? any/c any/c void?)]
  [nstableview-set-needs-display-in-rect! (c-> objc-object? any/c void?)]
  [nstableview-should-be-treated-as-ink-event (c-> objc-object? any/c boolean?)]
  [nstableview-should-delay-window-ordering-for-event (c-> objc-object? any/c boolean?)]
  [nstableview-show-context-help (c-> objc-object? any/c void?)]
  ...
  [nstableview-smart-magnify-with-event (c-> objc-object? any/c void?)]
  [nstableview-sort-subviews-using-function-context (c-> objc-object? (or/c cpointer? #f) (or/c cpointer? #f) void?)]
  [nstableview-supplemental-target-for-action-sender (c-> objc-object? cpointer? any/c any/c)]
  [nstableview-swipe-with-event (c-> objc-object? any/c void?)]
  [nstableview-table-column-with-identifier (c-> objc-object? any/c any/c)]
  [nstableview-tablet-point (c-> objc-object? any/c void?)]
  [nstableview-tablet-proximity (c-> objc-object? any/c void?)]
  [nstableview-take-double-value-from (c-> objc-object? any/c void?)]
  [nstableview-take-float-value-from (c-> objc-object? any/c void?)]
  [nstableview-take-int-value-from (c-> objc-object? any/c void?)]
  [nstableview-take-integer-value-from (c-> objc-object? any/c void?)]
  [nstableview-take-object-value-from (c-> objc-object? any/c void?)]
  [nstableview-take-string-value-from (c-> objc-object? any/c void?)]
  [nstableview-tile (c-> objc-object? void?)]
  [nstableview-touches-began-with-event (c-> objc-object? any/c void?)]
  [nstableview-touches-cancelled-with-event (c-> objc-object? any/c void?)]
  [nstableview-touches-ended-with-event (c-> objc-object? any/c void?)]
  [nstableview-touches-moved-with-event (c-> objc-object? any/c void?)]
  ...
  [nstableview-try-to-perform-with (c-> objc-object? cpointer? any/c boolean?)]
  [nstableview-unhide-rows-at-indexes-with-animation (c-> objc-object? any/c exact-nonnegative-integer? void?)]
  [nstableview-update-layer (c-> objc-object? void?)]
  [nstableview-valid-requestor-for-send-type-return-type (c-> objc-object? any/c any/c any/c)]
  ...
  [nstableview-view-will-move-to-superview (c-> objc-object? any/c void?)]
  [nstableview-view-will-move-to-window (c-> objc-object? any/c void?)]
  ...
  [nstableview-will-open-menu-with-event (c-> objc-object? any/c any/c void?)]
  [nstableview-will-remove-subview (c-> objc-object? any/c void?)]

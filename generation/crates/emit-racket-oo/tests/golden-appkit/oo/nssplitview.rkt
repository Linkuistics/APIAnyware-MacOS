...
(provide NSSplitView)
(provide/contract
  [make-nssplitview-init-with-coder (c-> (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nssplitview-autosave-name (c-> objc-object? any/c)]
  [nssplitview-set-autosave-name! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-background-filters (c-> objc-object? any/c)]
  [nssplitview-set-background-filters! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-baseline-offset-from-bottom (c-> objc-object? real?)]
  [nssplitview-bottom-anchor (c-> objc-object? any/c)]
  ...
  [nssplitview-candidate-list-touch-bar-item (c-> objc-object? any/c)]
  [nssplitview-center-x-anchor (c-> objc-object? any/c)]
  [nssplitview-center-y-anchor (c-> objc-object? any/c)]
  ...
  [nssplitview-compositing-filter (c-> objc-object? any/c)]
  [nssplitview-set-compositing-filter! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-constraints (c-> objc-object? any/c)]
  [nssplitview-content-filters (c-> objc-object? any/c)]
  [nssplitview-set-content-filters! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-default-focus-ring-type (c-> exact-nonnegative-integer?)]
  [nssplitview-default-menu (c-> any/c)]
  [nssplitview-delegate (c-> objc-object? any/c)]
  [nssplitview-set-delegate! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-divider-color (c-> objc-object? any/c)]
  ...
  [nssplitview-enclosing-menu-item (c-> objc-object? any/c)]
  [nssplitview-enclosing-scroll-view (c-> objc-object? any/c)]
  [nssplitview-first-baseline-anchor (c-> objc-object? any/c)]
  ...
  [nssplitview-focus-view (c-> any/c)]
  ...
  [nssplitview-set-gesture-recognizers! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-has-ambiguous-layout (c-> objc-object? boolean?)]
  [nssplitview-height-adjust-limit (c-> objc-object? real?)]
  [nssplitview-height-anchor (c-> objc-object? any/c)]
  ...
  [nssplitview-input-context (c-> objc-object? any/c)]
  [nssplitview-intrinsic-content-size (c-> objc-object? any/c)]
  [nssplitview-last-baseline-anchor (c-> objc-object? any/c)]
  [nssplitview-last-baseline-offset-from-bottom (c-> objc-object? real?)]
  [nssplitview-layer (c-> objc-object? any/c)]
  [nssplitview-set-layer! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nssplitview-layout-margins-guide (c-> objc-object? any/c)]
  [nssplitview-leading-anchor (c-> objc-object? any/c)]
  [nssplitview-left-anchor (c-> objc-object? any/c)]
  [nssplitview-menu (c-> objc-object? any/c)]
  [nssplitview-set-menu! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nssplitview-next-key-view (c-> objc-object? any/c)]
  [nssplitview-set-next-key-view! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-next-responder (c-> objc-object? any/c)]
  [nssplitview-set-next-responder! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-next-valid-key-view (c-> objc-object? any/c)]
  [nssplitview-opaque (c-> objc-object? boolean?)]
  [nssplitview-opaque-ancestor (c-> objc-object? any/c)]
  [nssplitview-page-footer (c-> objc-object? any/c)]
  [nssplitview-page-header (c-> objc-object? any/c)]
  ...
  [nssplitview-pressure-configuration (c-> objc-object? any/c)]
  [nssplitview-set-pressure-configuration! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-previous-key-view (c-> objc-object? any/c)]
  [nssplitview-previous-valid-key-view (c-> objc-object? any/c)]
  [nssplitview-print-job-title (c-> objc-object? any/c)]
  ...
  [nssplitview-right-anchor (c-> objc-object? any/c)]
  ...
  [nssplitview-safe-area-layout-guide (c-> objc-object? any/c)]
  [nssplitview-safe-area-rect (c-> objc-object? any/c)]
  [nssplitview-shadow (c-> objc-object? any/c)]
  [nssplitview-set-shadow! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-subviews (c-> objc-object? any/c)]
  [nssplitview-set-subviews! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-superview (c-> objc-object? any/c)]
  [nssplitview-tag (c-> objc-object? exact-integer?)]
  [nssplitview-tool-tip (c-> objc-object? any/c)]
  [nssplitview-set-tool-tip! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-top-anchor (c-> objc-object? any/c)]
  [nssplitview-touch-bar (c-> objc-object? any/c)]
  [nssplitview-set-touch-bar! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-tracking-areas (c-> objc-object? any/c)]
  [nssplitview-trailing-anchor (c-> objc-object? any/c)]
  ...
  [nssplitview-undo-manager (c-> objc-object? any/c)]
  [nssplitview-user-activity (c-> objc-object? any/c)]
  [nssplitview-set-user-activity! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nssplitview-width-anchor (c-> objc-object? any/c)]
  [nssplitview-window (c-> objc-object? any/c)]
  [nssplitview-writing-tools-coordinator (c-> objc-object? any/c)]
  [nssplitview-set-writing-tools-coordinator! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-accepts-first-mouse (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nssplitview-add-subview! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-add-subview-positioned-relative-to! (c-> objc-object? (or/c string? objc-object? cpointer?) exact-nonnegative-integer? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-add-tool-tip-rect-owner-user-data! (c-> objc-object? any/c (or/c string? objc-object? cpointer?) (or/c cpointer? #f) exact-integer?)]
  [nssplitview-adjust-scroll (c-> objc-object? any/c any/c)]
  [nssplitview-adjust-subviews (c-> objc-object? void?)]
  [nssplitview-ancestor-shared-with-view (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  [nssplitview-autoscroll (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  ...
  [nssplitview-begin-gesture-with-event! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-bitmap-image-rep-for-caching-display-in-rect (c-> objc-object? any/c any/c)]
  [nssplitview-cache-display-in-rect-to-bitmap-image-rep (c-> objc-object? any/c (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-center-scan-rect! (c-> objc-object? any/c any/c)]
  [nssplitview-change-mode-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-context-menu-key-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-convert-point-from-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  [nssplitview-convert-point-to-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nssplitview-convert-rect-from-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  [nssplitview-convert-rect-to-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nssplitview-convert-size-from-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  [nssplitview-convert-size-to-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nssplitview-cursor-update (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-did-add-subview (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-did-close-menu-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) void?)]
  ...
  [nssplitview-display-rect-ignoring-opacity-in-context! (c-> objc-object? any/c (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-draw-divider-in-rect (c-> objc-object? any/c void?)]
  [nssplitview-draw-rect (c-> objc-object? any/c void?)]
  [nssplitview-end-gesture-with-event! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-flags-changed (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nssplitview-help-requested (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-hit-test (c-> objc-object? any/c any/c)]
  [nssplitview-holding-priority-for-subview-at-index (c-> objc-object? exact-integer? real?)]
  [nssplitview-interpret-key-events (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-is-descendant-of (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  ...
  [nssplitview-is-subview-collapsed (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nssplitview-is-vertical (c-> objc-object? boolean?)]
  [nssplitview-key-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-key-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-layout (c-> objc-object? void?)]
  [nssplitview-layout-subtree-if-needed (c-> objc-object? void?)]
  [nssplitview-magnify-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-make-backing-layer (c-> objc-object? any/c)]
  [nssplitview-max-possible-position-of-divider-at-index (c-> objc-object? exact-integer? real?)]
  [nssplitview-menu-for-event (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nssplitview-mouse-cancelled (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-mouse-entered (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-mouse-exited (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-mouse-moved (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-needs-to-draw-rect (c-> objc-object? any/c boolean?)]
  [nssplitview-no-responder-for (c-> objc-object? cpointer? void?)]
  [nssplitview-other-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-other-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-other-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-perform-key-equivalent! (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nssplitview-prepare-content-in-rect (c-> objc-object? any/c void?)]
  [nssplitview-prepare-for-reuse (c-> objc-object? void?)]
  [nssplitview-pressure-change-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-quick-look-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nssplitview-replace-subview-with! (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) void?)]
  ...
  [nssplitview-right-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-right-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-right-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-rotate-by-angle (c-> objc-object? real? void?)]
  [nssplitview-rotate-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nssplitview-scroll-wheel (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nssplitview-should-be-treated-as-ink-event (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nssplitview-should-delay-window-ordering-for-event (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nssplitview-show-context-help (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-smart-magnify-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-sort-subviews-using-function-context (c-> objc-object? (or/c cpointer? #f) (or/c cpointer? #f) void?)]
  [nssplitview-supplemental-target-for-action-sender (c-> objc-object? cpointer? (or/c string? objc-object? cpointer?) any/c)]
  [nssplitview-swipe-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-tablet-point (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-tablet-proximity (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-touches-began-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-touches-cancelled-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-touches-ended-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-touches-moved-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nssplitview-try-to-perform-with (c-> objc-object? cpointer? (or/c string? objc-object? cpointer?) boolean?)]
  [nssplitview-update-layer (c-> objc-object? void?)]
  [nssplitview-valid-requestor-for-send-type-return-type (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nssplitview-view-will-move-to-superview (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-view-will-move-to-window (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nssplitview-will-open-menu-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) void?)]
  [nssplitview-will-remove-subview (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
...
(define (nssplitview-no-responder-for self event-selector)
  (_msg-34 (coerce-arg self) (sel_registerName "noResponderFor:") event-selector))
...
(define (nssplitview-supplemental-target-for-action-sender self action sender)
  (wrap-objc-object
   (_msg-36 (coerce-arg self) (sel_registerName "supplementalTargetForAction:sender:") action (coerce-arg sender))
   ))
...
(define (nssplitview-try-to-perform-with self action object)
  (_msg-35 (coerce-arg self) (sel_registerName "tryToPerform:with:") action (coerce-arg object)))

...
(provide/contract
  ...
  [nssplitview-ancestor-shared-with-view (c-> objc-object? (or/c string? objc-object? #f) any/c)]
  ...
  [nssplitview-menu-for-event (c-> objc-object? (or/c string? objc-object? #f) any/c)]

...
(provide NSSplitView)
(provide/contract
  [make-nssplitview-init-with-coder (c-> any/c any/c)]
  ...
  [nssplitview-set-autosave-name! (c-> objc-object? any/c void?)]
  [nssplitview-background-filters (c-> objc-object? any/c)]
  [nssplitview-set-background-filters! (c-> objc-object? any/c void?)]
  ...
  [nssplitview-set-compositing-filter! (c-> objc-object? any/c void?)]
  [nssplitview-constraints (c-> objc-object? any/c)]
  [nssplitview-content-filters (c-> objc-object? any/c)]
  [nssplitview-set-content-filters! (c-> objc-object? any/c void?)]
  ...
  [nssplitview-set-delegate! (c-> objc-object? any/c void?)]
  ...
  [nssplitview-set-gesture-recognizers! (c-> objc-object? any/c void?)]
  ...
  [nssplitview-set-layer! (c-> objc-object? any/c void?)]
  ...
  [nssplitview-set-menu! (c-> objc-object? any/c void?)]
  ...
  [nssplitview-set-next-key-view! (c-> objc-object? any/c void?)]
  [nssplitview-next-responder (c-> objc-object? any/c)]
  [nssplitview-set-next-responder! (c-> objc-object? any/c void?)]
  ...
  [nssplitview-set-pressure-configuration! (c-> objc-object? any/c void?)]
  ...
  [nssplitview-set-shadow! (c-> objc-object? any/c void?)]
  [nssplitview-subviews (c-> objc-object? any/c)]
  [nssplitview-set-subviews! (c-> objc-object? any/c void?)]
  ...
  [nssplitview-set-tool-tip! (c-> objc-object? any/c void?)]
  [nssplitview-top-anchor (c-> objc-object? any/c)]
  [nssplitview-touch-bar (c-> objc-object? any/c)]
  [nssplitview-set-touch-bar! (c-> objc-object? any/c void?)]
  ...
  [nssplitview-set-user-activity! (c-> objc-object? any/c void?)]
  ...
  [nssplitview-set-writing-tools-coordinator! (c-> objc-object? any/c void?)]
  [nssplitview-accepts-first-mouse (c-> objc-object? any/c boolean?)]
  [nssplitview-add-subview! (c-> objc-object? any/c void?)]
  [nssplitview-add-subview-positioned-relative-to! (c-> objc-object? any/c exact-nonnegative-integer? any/c void?)]
  [nssplitview-add-tool-tip-rect-owner-user-data! (c-> objc-object? any/c any/c (or/c cpointer? #f) exact-integer?)]
  [nssplitview-adjust-scroll (c-> objc-object? any/c any/c)]
  [nssplitview-adjust-subviews (c-> objc-object? void?)]
  [nssplitview-ancestor-shared-with-view (c-> objc-object? any/c any/c)]
  [nssplitview-autoscroll (c-> objc-object? any/c boolean?)]
  ...
  [nssplitview-begin-gesture-with-event! (c-> objc-object? any/c void?)]
  [nssplitview-bitmap-image-rep-for-caching-display-in-rect (c-> objc-object? any/c any/c)]
  [nssplitview-cache-display-in-rect-to-bitmap-image-rep (c-> objc-object? any/c any/c void?)]
  [nssplitview-center-scan-rect! (c-> objc-object? any/c any/c)]
  [nssplitview-change-mode-with-event (c-> objc-object? any/c void?)]
  [nssplitview-context-menu-key-down (c-> objc-object? any/c void?)]
  [nssplitview-convert-point-from-view (c-> objc-object? any/c any/c any/c)]
  [nssplitview-convert-point-to-view (c-> objc-object? any/c any/c any/c)]
  ...
  [nssplitview-convert-rect-from-view (c-> objc-object? any/c any/c any/c)]
  [nssplitview-convert-rect-to-view (c-> objc-object? any/c any/c any/c)]
  ...
  [nssplitview-convert-size-from-view (c-> objc-object? any/c any/c any/c)]
  [nssplitview-convert-size-to-view (c-> objc-object? any/c any/c any/c)]
  ...
  [nssplitview-cursor-update (c-> objc-object? any/c void?)]
  [nssplitview-did-add-subview (c-> objc-object? any/c void?)]
  [nssplitview-did-close-menu-with-event (c-> objc-object? any/c any/c void?)]
  ...
  [nssplitview-display-rect-ignoring-opacity-in-context! (c-> objc-object? any/c any/c void?)]
  [nssplitview-draw-divider-in-rect (c-> objc-object? any/c void?)]
  [nssplitview-draw-rect (c-> objc-object? any/c void?)]
  [nssplitview-end-gesture-with-event! (c-> objc-object? any/c void?)]
  [nssplitview-flags-changed (c-> objc-object? any/c void?)]
  ...
  [nssplitview-help-requested (c-> objc-object? any/c void?)]
  ...
  [nssplitview-interpret-key-events (c-> objc-object? any/c void?)]
  [nssplitview-is-descendant-of (c-> objc-object? any/c boolean?)]
  ...
  [nssplitview-is-subview-collapsed (c-> objc-object? any/c boolean?)]
  [nssplitview-is-vertical (c-> objc-object? boolean?)]
  [nssplitview-key-down (c-> objc-object? any/c void?)]
  [nssplitview-key-up (c-> objc-object? any/c void?)]
  [nssplitview-layout (c-> objc-object? void?)]
  [nssplitview-layout-subtree-if-needed (c-> objc-object? void?)]
  [nssplitview-magnify-with-event (c-> objc-object? any/c void?)]
  ...
  [nssplitview-menu-for-event (c-> objc-object? any/c any/c)]
  ...
  [nssplitview-mouse-cancelled (c-> objc-object? any/c void?)]
  [nssplitview-mouse-down (c-> objc-object? any/c void?)]
  [nssplitview-mouse-dragged (c-> objc-object? any/c void?)]
  [nssplitview-mouse-entered (c-> objc-object? any/c void?)]
  [nssplitview-mouse-exited (c-> objc-object? any/c void?)]
  [nssplitview-mouse-moved (c-> objc-object? any/c void?)]
  [nssplitview-mouse-up (c-> objc-object? any/c void?)]
  [nssplitview-needs-to-draw-rect (c-> objc-object? any/c boolean?)]
  [nssplitview-no-responder-for (c-> objc-object? cpointer? void?)]
  [nssplitview-other-mouse-down (c-> objc-object? any/c void?)]
  [nssplitview-other-mouse-dragged (c-> objc-object? any/c void?)]
  [nssplitview-other-mouse-up (c-> objc-object? any/c void?)]
  [nssplitview-perform-key-equivalent! (c-> objc-object? any/c boolean?)]
  [nssplitview-prepare-content-in-rect (c-> objc-object? any/c void?)]
  [nssplitview-prepare-for-reuse (c-> objc-object? void?)]
  [nssplitview-pressure-change-with-event (c-> objc-object? any/c void?)]
  [nssplitview-quick-look-with-event (c-> objc-object? any/c void?)]
  ...
  [nssplitview-replace-subview-with! (c-> objc-object? any/c any/c void?)]
  ...
  [nssplitview-right-mouse-down (c-> objc-object? any/c void?)]
  [nssplitview-right-mouse-dragged (c-> objc-object? any/c void?)]
  [nssplitview-right-mouse-up (c-> objc-object? any/c void?)]
  [nssplitview-rotate-by-angle (c-> objc-object? real? void?)]
  [nssplitview-rotate-with-event (c-> objc-object? any/c void?)]
  ...
  [nssplitview-scroll-wheel (c-> objc-object? any/c void?)]
  ...
  [nssplitview-should-be-treated-as-ink-event (c-> objc-object? any/c boolean?)]
  [nssplitview-should-delay-window-ordering-for-event (c-> objc-object? any/c boolean?)]
  [nssplitview-show-context-help (c-> objc-object? any/c void?)]
  [nssplitview-smart-magnify-with-event (c-> objc-object? any/c void?)]
  [nssplitview-sort-subviews-using-function-context (c-> objc-object? (or/c cpointer? #f) (or/c cpointer? #f) void?)]
  [nssplitview-supplemental-target-for-action-sender (c-> objc-object? cpointer? any/c any/c)]
  [nssplitview-swipe-with-event (c-> objc-object? any/c void?)]
  [nssplitview-tablet-point (c-> objc-object? any/c void?)]
  [nssplitview-tablet-proximity (c-> objc-object? any/c void?)]
  [nssplitview-touches-began-with-event (c-> objc-object? any/c void?)]
  [nssplitview-touches-cancelled-with-event (c-> objc-object? any/c void?)]
  [nssplitview-touches-ended-with-event (c-> objc-object? any/c void?)]
  [nssplitview-touches-moved-with-event (c-> objc-object? any/c void?)]
  ...
  [nssplitview-try-to-perform-with (c-> objc-object? cpointer? any/c boolean?)]
  [nssplitview-update-layer (c-> objc-object? void?)]
  [nssplitview-valid-requestor-for-send-type-return-type (c-> objc-object? any/c any/c any/c)]
  ...
  [nssplitview-view-will-move-to-superview (c-> objc-object? any/c void?)]
  [nssplitview-view-will-move-to-window (c-> objc-object? any/c void?)]
  ...
  [nssplitview-will-open-menu-with-event (c-> objc-object? any/c any/c void?)]
  [nssplitview-will-remove-subview (c-> objc-object? any/c void?)]

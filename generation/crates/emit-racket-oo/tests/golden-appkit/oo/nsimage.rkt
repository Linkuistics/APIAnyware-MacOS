...
(provide/contract
  ...
  [make-nsimage-init-with-coder (c-> any/c any/c)]
  [make-nsimage-init-with-contents-of-file (c-> any/c any/c)]
  [make-nsimage-init-with-contents-of-url (c-> any/c any/c)]
  [make-nsimage-init-with-data (c-> any/c any/c)]
  [make-nsimage-init-with-data-ignoring-orientation (c-> any/c any/c)]
  [make-nsimage-init-with-pasteboard (c-> any/c any/c)]
  ...
  [nsimage-set-accessibility-description! (c-> objc-object? any/c void?)]
  ...
  [nsimage-set-background-color! (c-> objc-object? any/c void?)]
  ...
  [nsimage-set-delegate! (c-> objc-object? any/c void?)]
  ...
  [nsimage-cg-image-for-proposed-rect-context-hints (c-> objc-object? (or/c cpointer? #f) any/c any/c (or/c cpointer? #f))]
  [nsimage-tiff-representation-using-compression-factor (c-> objc-object? exact-nonnegative-integer? real? any/c)]
  [nsimage-add-representation! (c-> objc-object? any/c void?)]
  [nsimage-add-representations! (c-> objc-object? any/c void?)]
  [nsimage-best-representation-for-rect-context-hints (c-> objc-object? any/c any/c any/c any/c)]
  ...
  [nsimage-draw-in-rect-from-rect-operation-fraction-respect-flipped-hints (c-> objc-object? any/c any/c exact-nonnegative-integer? real? boolean? any/c void?)]
  [nsimage-draw-representation-in-rect (c-> objc-object? any/c any/c boolean?)]
  [nsimage-hit-test-rect-with-image-destination-rect-context-hints-flipped (c-> objc-object? any/c any/c any/c any/c boolean? boolean?)]
  [nsimage-image-with-locale (c-> objc-object? any/c any/c)]
  [nsimage-image-with-symbol-configuration (c-> objc-object? any/c any/c)]
  [nsimage-init-by-referencing-file (c-> objc-object? any/c any/c)]
  [nsimage-init-by-referencing-url (c-> objc-object? any/c any/c)]
  ...
  [nsimage-remove-representation! (c-> objc-object? any/c void?)]
  [nsimage-set-name! (c-> objc-object? any/c boolean?)]
  [nsimage-can-init-with-pasteboard (c-> any/c boolean?)]
  [nsimage-image-named (c-> any/c any/c)]
  [nsimage-image-with-size-flipped-drawing-handler (c-> any/c boolean? (or/c procedure? #f) any/c)]
  [nsimage-image-with-symbol-name-bundle-variable-value (c-> any/c any/c real? any/c)]
  [nsimage-image-with-symbol-name-variable-value (c-> any/c real? any/c)]
  [nsimage-image-with-system-symbol-name-accessibility-description (c-> any/c any/c any/c)]
  [nsimage-image-with-system-symbol-name-variable-value-accessibility-description (c-> any/c real? any/c any/c)]
  )

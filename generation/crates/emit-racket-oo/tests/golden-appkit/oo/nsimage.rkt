...
(provide/contract
  ...
  [make-nsimage-init-with-coder (c-> (or/c string? objc-object? cpointer?) any/c)]
  [make-nsimage-init-with-contents-of-file (c-> (or/c string? objc-object? cpointer?) any/c)]
  [make-nsimage-init-with-contents-of-url (c-> (or/c string? objc-object? cpointer?) any/c)]
  [make-nsimage-init-with-data (c-> (or/c string? objc-object? cpointer?) any/c)]
  [make-nsimage-init-with-data-ignoring-orientation (c-> (or/c string? objc-object? cpointer?) any/c)]
  [make-nsimage-init-with-pasteboard (c-> (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nsimage-set-accessibility-description! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsimage-set-background-color! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsimage-set-delegate! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsimage-cg-image-for-proposed-rect-context-hints (c-> objc-object? (or/c cpointer? #f) (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) (or/c cpointer? #f))]
  [nsimage-tiff-representation-using-compression-factor (c-> objc-object? exact-nonnegative-integer? real? any/c)]
  [nsimage-add-representation! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsimage-add-representations! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsimage-best-representation-for-rect-context-hints (c-> objc-object? any/c (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nsimage-draw-in-rect-from-rect-operation-fraction-respect-flipped-hints (c-> objc-object? any/c any/c exact-nonnegative-integer? real? boolean? (or/c string? objc-object? cpointer?) void?)]
  [nsimage-draw-representation-in-rect (c-> objc-object? (or/c string? objc-object? cpointer?) any/c boolean?)]
  [nsimage-hit-test-rect-with-image-destination-rect-context-hints-flipped (c-> objc-object? any/c any/c (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) boolean? boolean?)]
  [nsimage-image-with-locale (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  [nsimage-image-with-symbol-configuration (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  [nsimage-init-by-referencing-file (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  [nsimage-init-by-referencing-url (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nsimage-remove-representation! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsimage-set-name! (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nsimage-can-init-with-pasteboard (c-> (or/c string? objc-object? cpointer?) boolean?)]
  [nsimage-image-named (c-> (or/c string? objc-object? cpointer?) any/c)]
  [nsimage-image-with-size-flipped-drawing-handler (c-> any/c boolean? (or/c procedure? #f) any/c)]
  [nsimage-image-with-symbol-name-bundle-variable-value (c-> (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) real? any/c)]
  [nsimage-image-with-symbol-name-variable-value (c-> (or/c string? objc-object? cpointer?) real? any/c)]
  [nsimage-image-with-system-symbol-name-accessibility-description (c-> (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  [nsimage-image-with-system-symbol-name-variable-value-accessibility-description (c-> (or/c string? objc-object? cpointer?) real? (or/c string? objc-object? cpointer?) any/c)]
  )

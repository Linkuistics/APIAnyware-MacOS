...
(provide/contract
  ...
  [nstextfield-ancestor-shared-with-view (c-> objc-object? (or/c string? objc-object? #f) any/c)]
  ...
  [nstextfield-menu-for-event (c-> objc-object? (or/c string? objc-object? #f) any/c)]

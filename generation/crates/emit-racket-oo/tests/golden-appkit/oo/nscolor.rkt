...
(provide/contract
  ...
  [nscolor-blended-color-with-fraction-of-color (c-> objc-object? real? (or/c string? objc-object? #f) any/c)]
  [nscolor-color-by-applying-content-headroom (c-> objc-object? real? any/c)]
  [nscolor-color-using-color-space (c-> objc-object? (or/c string? objc-object? #f) any/c)]
  ...
  [nscolor-color-from-pasteboard (c-> (or/c string? objc-object? #f) any/c)]
  [nscolor-color-named (c-> (or/c string? objc-object? #f) any/c)]
  [nscolor-color-named-bundle (c-> (or/c string? objc-object? #f) (or/c string? objc-object? #f) any/c)]
  ...
  [nscolor-color-with-catalog-name-color-name (c-> (or/c string? objc-object? #f) (or/c string? objc-object? #f) any/c)]
  [nscolor-color-with-color-space-components-count (c-> (or/c string? objc-object? #f) (or/c cpointer? #f) exact-integer? any/c)]
  [nscolor-color-with-color-space-hue-saturation-brightness-alpha (c-> (or/c string? objc-object? #f) real? real? real? real? any/c)]
  ...
  [nscolor-color-with-name-dynamic-provider (c-> (or/c string? objc-object? #f) (or/c procedure? #f) any/c)]
  [nscolor-color-with-pattern-image (c-> (or/c string? objc-object? #f) any/c)]

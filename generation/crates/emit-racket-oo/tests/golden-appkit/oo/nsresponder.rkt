...
(provide NSResponder)
(provide/contract
  [make-nsresponder-init-with-coder (c-> any/c any/c)]
  [nsresponder-accepts-first-responder (c-> objc-object? boolean?)]
  [nsresponder-menu (c-> objc-object? any/c)]
  [nsresponder-set-menu! (c-> objc-object? any/c void?)]
  [nsresponder-next-responder (c-> objc-object? any/c)]
  [nsresponder-set-next-responder! (c-> objc-object? any/c void?)]
  [nsresponder-restorable-state-key-paths (c-> any/c)]
  [nsresponder-touch-bar (c-> objc-object? any/c)]
  [nsresponder-set-touch-bar! (c-> objc-object? any/c void?)]
  [nsresponder-undo-manager (c-> objc-object? any/c)]
  [nsresponder-user-activity (c-> objc-object? any/c)]
  [nsresponder-set-user-activity! (c-> objc-object? any/c void?)]
  [nsresponder-become-first-responder (c-> objc-object? boolean?)]
  [nsresponder-begin-gesture-with-event! (c-> objc-object? any/c void?)]
  [nsresponder-change-mode-with-event (c-> objc-object? any/c void?)]
  [nsresponder-context-menu-key-down (c-> objc-object? any/c void?)]
  [nsresponder-cursor-update (c-> objc-object? any/c void?)]
  [nsresponder-end-gesture-with-event! (c-> objc-object? any/c void?)]
  [nsresponder-flags-changed (c-> objc-object? any/c void?)]
  [nsresponder-flush-buffered-key-events (c-> objc-object? void?)]
  [nsresponder-help-requested (c-> objc-object? any/c void?)]
  [nsresponder-interpret-key-events (c-> objc-object? any/c void?)]
  [nsresponder-key-down (c-> objc-object? any/c void?)]
  [nsresponder-key-up (c-> objc-object? any/c void?)]
  [nsresponder-magnify-with-event (c-> objc-object? any/c void?)]
  [nsresponder-mouse-cancelled (c-> objc-object? any/c void?)]
  [nsresponder-mouse-down (c-> objc-object? any/c void?)]
  [nsresponder-mouse-dragged (c-> objc-object? any/c void?)]
  [nsresponder-mouse-entered (c-> objc-object? any/c void?)]
  [nsresponder-mouse-exited (c-> objc-object? any/c void?)]
  [nsresponder-mouse-moved (c-> objc-object? any/c void?)]
  [nsresponder-mouse-up (c-> objc-object? any/c void?)]
  [nsresponder-no-responder-for (c-> objc-object? cpointer? void?)]
  [nsresponder-other-mouse-down (c-> objc-object? any/c void?)]
  [nsresponder-other-mouse-dragged (c-> objc-object? any/c void?)]
  [nsresponder-other-mouse-up (c-> objc-object? any/c void?)]
  [nsresponder-perform-key-equivalent! (c-> objc-object? any/c boolean?)]
  [nsresponder-pressure-change-with-event (c-> objc-object? any/c void?)]
  [nsresponder-quick-look-with-event (c-> objc-object? any/c void?)]
  [nsresponder-resign-first-responder (c-> objc-object? boolean?)]
  [nsresponder-right-mouse-down (c-> objc-object? any/c void?)]
  [nsresponder-right-mouse-dragged (c-> objc-object? any/c void?)]
  [nsresponder-right-mouse-up (c-> objc-object? any/c void?)]
  [nsresponder-rotate-with-event (c-> objc-object? any/c void?)]
  [nsresponder-scroll-wheel (c-> objc-object? any/c void?)]
  [nsresponder-should-be-treated-as-ink-event (c-> objc-object? any/c boolean?)]
  [nsresponder-show-context-help (c-> objc-object? any/c void?)]
  [nsresponder-smart-magnify-with-event (c-> objc-object? any/c void?)]
  [nsresponder-supplemental-target-for-action-sender (c-> objc-object? cpointer? any/c any/c)]
  [nsresponder-swipe-with-event (c-> objc-object? any/c void?)]
  [nsresponder-tablet-point (c-> objc-object? any/c void?)]
  [nsresponder-tablet-proximity (c-> objc-object? any/c void?)]
  [nsresponder-touches-began-with-event (c-> objc-object? any/c void?)]
  [nsresponder-touches-cancelled-with-event (c-> objc-object? any/c void?)]
  [nsresponder-touches-ended-with-event (c-> objc-object? any/c void?)]
  [nsresponder-touches-moved-with-event (c-> objc-object? any/c void?)]
  [nsresponder-try-to-perform-with (c-> objc-object? cpointer? any/c boolean?)]
  [nsresponder-valid-requestor-for-send-type-return-type (c-> objc-object? any/c any/c any/c)]

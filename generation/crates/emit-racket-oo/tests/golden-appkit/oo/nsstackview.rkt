...
(provide/contract
  ...
  [nsstackview-ancestor-shared-with-view (c-> objc-object? (or/c string? objc-object? #f) any/c)]
  ...
  [nsstackview-menu-for-event (c-> objc-object? (or/c string? objc-object? #f) any/c)]
...
(define (nsstackview-no-responder-for self event-selector)
  (_msg-37 (coerce-arg self) (sel_registerName "noResponderFor:") (sel_registerName event-selector)))
...
(define (nsstackview-supplemental-target-for-action-sender self action sender)
  (wrap-objc-object
   (_msg-39 (coerce-arg self) (sel_registerName "supplementalTargetForAction:sender:") (sel_registerName action) (coerce-arg sender))
   ))
...
(define (nsstackview-try-to-perform-with self action object)
  (_msg-38 (coerce-arg self) (sel_registerName "tryToPerform:with:") (sel_registerName action) (coerce-arg object)))

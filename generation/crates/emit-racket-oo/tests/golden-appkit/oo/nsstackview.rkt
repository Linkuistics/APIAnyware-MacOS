...
(provide NSStackView)
(provide/contract
  [make-nsstackview-init-with-coder (c-> (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nsstackview-set-background-filters! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-baseline-offset-from-bottom (c-> objc-object? real?)]
  [nsstackview-bottom-anchor (c-> objc-object? any/c)]
  ...
  [nsstackview-candidate-list-touch-bar-item (c-> objc-object? any/c)]
  [nsstackview-center-x-anchor (c-> objc-object? any/c)]
  [nsstackview-center-y-anchor (c-> objc-object? any/c)]
  ...
  [nsstackview-compositing-filter (c-> objc-object? any/c)]
  [nsstackview-set-compositing-filter! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-constraints (c-> objc-object? any/c)]
  [nsstackview-content-filters (c-> objc-object? any/c)]
  [nsstackview-set-content-filters! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-default-focus-ring-type (c-> exact-nonnegative-integer?)]
  [nsstackview-default-menu (c-> any/c)]
  [nsstackview-delegate (c-> objc-object? any/c)]
  [nsstackview-set-delegate! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-enclosing-menu-item (c-> objc-object? any/c)]
  [nsstackview-enclosing-scroll-view (c-> objc-object? any/c)]
  [nsstackview-first-baseline-anchor (c-> objc-object? any/c)]
  ...
  [nsstackview-focus-view (c-> any/c)]
  ...
  [nsstackview-set-gesture-recognizers! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-height-anchor (c-> objc-object? any/c)]
  ...
  [nsstackview-input-context (c-> objc-object? any/c)]
  [nsstackview-intrinsic-content-size (c-> objc-object? any/c)]
  [nsstackview-last-baseline-anchor (c-> objc-object? any/c)]
  [nsstackview-last-baseline-offset-from-bottom (c-> objc-object? real?)]
  [nsstackview-layer (c-> objc-object? any/c)]
  [nsstackview-set-layer! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-layout-margins-guide (c-> objc-object? any/c)]
  [nsstackview-leading-anchor (c-> objc-object? any/c)]
  [nsstackview-left-anchor (c-> objc-object? any/c)]
  [nsstackview-menu (c-> objc-object? any/c)]
  [nsstackview-set-menu! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-next-key-view (c-> objc-object? any/c)]
  [nsstackview-set-next-key-view! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-next-responder (c-> objc-object? any/c)]
  [nsstackview-set-next-responder! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-next-valid-key-view (c-> objc-object? any/c)]
  [nsstackview-opaque (c-> objc-object? boolean?)]
  [nsstackview-opaque-ancestor (c-> objc-object? any/c)]
  ...
  [nsstackview-page-footer (c-> objc-object? any/c)]
  [nsstackview-page-header (c-> objc-object? any/c)]
  ...
  [nsstackview-pressure-configuration (c-> objc-object? any/c)]
  [nsstackview-set-pressure-configuration! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-previous-key-view (c-> objc-object? any/c)]
  [nsstackview-previous-valid-key-view (c-> objc-object? any/c)]
  [nsstackview-print-job-title (c-> objc-object? any/c)]
  ...
  [nsstackview-right-anchor (c-> objc-object? any/c)]
  ...
  [nsstackview-safe-area-layout-guide (c-> objc-object? any/c)]
  [nsstackview-safe-area-rect (c-> objc-object? any/c)]
  [nsstackview-shadow (c-> objc-object? any/c)]
  [nsstackview-set-shadow! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-set-subviews! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-superview (c-> objc-object? any/c)]
  [nsstackview-tag (c-> objc-object? exact-integer?)]
  [nsstackview-tool-tip (c-> objc-object? any/c)]
  [nsstackview-set-tool-tip! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-top-anchor (c-> objc-object? any/c)]
  [nsstackview-touch-bar (c-> objc-object? any/c)]
  [nsstackview-set-touch-bar! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-tracking-areas (c-> objc-object? any/c)]
  [nsstackview-trailing-anchor (c-> objc-object? any/c)]
  ...
  [nsstackview-undo-manager (c-> objc-object? any/c)]
  [nsstackview-user-activity (c-> objc-object? any/c)]
  [nsstackview-set-user-activity! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-width-anchor (c-> objc-object? any/c)]
  [nsstackview-window (c-> objc-object? any/c)]
  [nsstackview-writing-tools-coordinator (c-> objc-object? any/c)]
  [nsstackview-set-writing-tools-coordinator! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-accepts-first-mouse (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nsstackview-add-arranged-subview! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-add-subview! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-add-subview-positioned-relative-to! (c-> objc-object? (or/c string? objc-object? cpointer?) exact-nonnegative-integer? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-add-tool-tip-rect-owner-user-data! (c-> objc-object? any/c (or/c string? objc-object? cpointer?) (or/c cpointer? #f) exact-integer?)]
  [nsstackview-adjust-scroll (c-> objc-object? any/c any/c)]
  [nsstackview-ancestor-shared-with-view (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  [nsstackview-autoscroll (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  ...
  [nsstackview-begin-gesture-with-event! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-bitmap-image-rep-for-caching-display-in-rect (c-> objc-object? any/c any/c)]
  [nsstackview-cache-display-in-rect-to-bitmap-image-rep (c-> objc-object? any/c (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-center-scan-rect! (c-> objc-object? any/c any/c)]
  [nsstackview-change-mode-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-clipping-resistance-priority-for-orientation (c-> objc-object? exact-nonnegative-integer? real?)]
  [nsstackview-context-menu-key-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-convert-point-from-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  [nsstackview-convert-point-to-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nsstackview-convert-rect-from-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  [nsstackview-convert-rect-to-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nsstackview-convert-size-from-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  [nsstackview-convert-size-to-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nsstackview-cursor-update (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-custom-spacing-after-view (c-> objc-object? (or/c string? objc-object? cpointer?) real?)]
  [nsstackview-did-add-subview (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-did-close-menu-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-display-rect-ignoring-opacity-in-context! (c-> objc-object? any/c (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-draw-rect (c-> objc-object? any/c void?)]
  [nsstackview-end-gesture-with-event! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-flags-changed (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-help-requested (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-hit-test (c-> objc-object? any/c any/c)]
  [nsstackview-hugging-priority-for-orientation (c-> objc-object? exact-nonnegative-integer? real?)]
  [nsstackview-insert-arranged-subview-at-index! (c-> objc-object? (or/c string? objc-object? cpointer?) exact-integer? void?)]
  [nsstackview-interpret-key-events (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-is-descendant-of (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  ...
  [nsstackview-key-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-key-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-layout (c-> objc-object? void?)]
  [nsstackview-layout-subtree-if-needed (c-> objc-object? void?)]
  [nsstackview-magnify-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-make-backing-layer (c-> objc-object? any/c)]
  [nsstackview-menu-for-event (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  [nsstackview-mouse-in-rect (c-> objc-object? any/c any/c boolean?)]
  [nsstackview-mouse-cancelled (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-mouse-entered (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-mouse-exited (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-mouse-moved (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-needs-to-draw-rect (c-> objc-object? any/c boolean?)]
  [nsstackview-no-responder-for (c-> objc-object? cpointer? void?)]
  [nsstackview-other-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-other-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-other-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-perform-key-equivalent! (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nsstackview-prepare-content-in-rect (c-> objc-object? any/c void?)]
  [nsstackview-prepare-for-reuse (c-> objc-object? void?)]
  [nsstackview-pressure-change-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-quick-look-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-remove-arranged-subview! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-replace-subview-with! (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-right-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-right-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-right-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-rotate-by-angle (c-> objc-object? real? void?)]
  [nsstackview-rotate-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-scroll-wheel (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-set-custom-spacing-after-view! (c-> objc-object? real? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-set-visibility-priority-for-view! (c-> objc-object? real? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-should-be-treated-as-ink-event (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nsstackview-should-delay-window-ordering-for-event (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nsstackview-show-context-help (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-smart-magnify-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-sort-subviews-using-function-context (c-> objc-object? (or/c cpointer? #f) (or/c cpointer? #f) void?)]
  [nsstackview-supplemental-target-for-action-sender (c-> objc-object? cpointer? (or/c string? objc-object? cpointer?) any/c)]
  [nsstackview-swipe-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-tablet-point (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-tablet-proximity (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-touches-began-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-touches-cancelled-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-touches-ended-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-touches-moved-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsstackview-try-to-perform-with (c-> objc-object? cpointer? (or/c string? objc-object? cpointer?) boolean?)]
  [nsstackview-update-layer (c-> objc-object? void?)]
  [nsstackview-valid-requestor-for-send-type-return-type (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nsstackview-view-will-move-to-superview (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-view-will-move-to-window (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-view-will-start-live-resize (c-> objc-object? void?)]
  [nsstackview-view-with-tag (c-> objc-object? exact-integer? any/c)]
  [nsstackview-visibility-priority-for-view (c-> objc-object? (or/c string? objc-object? cpointer?) real?)]
  ...
  [nsstackview-will-open-menu-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-will-remove-subview (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsstackview-is-compatible-with-responsive-scrolling (c-> boolean?)]
  [nsstackview-stack-view-with-views (c-> (or/c string? objc-object? cpointer?) any/c)]
  )
...
(define _msg-29  ; (_fun _pointer _pointer _float _uint64 -> _void)
  (get-ffi-obj "objc_msgSend" _objc-lib (_fun _pointer _pointer _float _uint64 -> _void)))
...
(define (nsstackview-set-alignment! self value)
  (_msg-43 (coerce-arg self) (sel_registerName "setAlignment:") value))
...
(define (nsstackview-distribution self)
  (tell #:type _uint64 (coerce-arg self) distribution))
(define (nsstackview-set-distribution! self value)
  (_msg-43 (coerce-arg self) (sel_registerName "setDistribution:") value))
...
(define (nsstackview-set-layer-contents-placement! self value)
  (_msg-43 (coerce-arg self) (sel_registerName "setLayerContentsPlacement:") value))
...
(define (nsstackview-set-layer-contents-redraw-policy! self value)
  (_msg-43 (coerce-arg self) (sel_registerName "setLayerContentsRedrawPolicy:") value))
...
(define (nsstackview-orientation self)
  (tell #:type _uint64 (coerce-arg self) orientation))
(define (nsstackview-set-orientation! self value)
  (_msg-43 (coerce-arg self) (sel_registerName "setOrientation:") value))
...
(define (nsstackview-set-user-interface-layout-direction! self value)
  (_msg-43 (coerce-arg self) (sel_registerName "setUserInterfaceLayoutDirection:") value))
...
(define (nsstackview-clipping-resistance-priority-for-orientation self orientation)
  (_msg-42 (coerce-arg self) (sel_registerName "clippingResistancePriorityForOrientation:") orientation))
...
(define (nsstackview-get-rects-being-drawn-count self rects count)
  (_msg-40 (coerce-arg self) (sel_registerName "getRectsBeingDrawn:count:") rects count))
(define (nsstackview-get-rects-exposed-during-live-resize-count self exposed-rects count)
  (_msg-40 (coerce-arg self) (sel_registerName "getRectsExposedDuringLiveResize:count:") exposed-rects count))
...
(define (nsstackview-hugging-priority-for-orientation self orientation)
  (_msg-42 (coerce-arg self) (sel_registerName "huggingPriorityForOrientation:") orientation))
...
(define (nsstackview-no-responder-for self event-selector)
  (_msg-37 (coerce-arg self) (sel_registerName "noResponderFor:") event-selector))
...
(define (nsstackview-remove-tool-tip! self tag)
  (_msg-36 (coerce-arg self) (sel_registerName "removeToolTip:") tag))
...
(define (nsstackview-sort-subviews-using-function-context self compare context)
  (_msg-40 (coerce-arg self) (sel_registerName "sortSubviewsUsingFunction:context:") compare context))
(define (nsstackview-supplemental-target-for-action-sender self action sender)
  (wrap-objc-object
   (_msg-39 (coerce-arg self) (sel_registerName "supplementalTargetForAction:sender:") action (coerce-arg sender))
   ))
...
(define (nsstackview-try-to-perform-with self action object)
  (_msg-38 (coerce-arg self) (sel_registerName "tryToPerform:with:") action (coerce-arg object)))
...
(define (nsstackview-view-with-tag self tag)
  (wrap-objc-object
   (_msg-35 (coerce-arg self) (sel_registerName "viewWithTag:") tag)
   ))

...
(provide NSWindow)
(provide/contract
  [make-nswindow-init-with-coder (c-> (or/c string? objc-object? cpointer?) any/c)]
  ...
  [make-nswindow-init-with-content-rect-style-mask-backing-defer-screen (c-> any/c exact-nonnegative-integer? exact-nonnegative-integer? boolean? (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nswindow-set-appearance-source! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-background-color! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-color-space! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-content-view! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-content-view-controller (c-> objc-object? any/c)]
  [nswindow-set-content-view-controller! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-default-button-cell! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-default-depth-limit (c-> exact-nonnegative-integer?)]
  [nswindow-delegate (c-> objc-object? any/c)]
  [nswindow-set-delegate! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-initial-first-responder! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-menu! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-miniwindow-image! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-miniwindow-title (c-> objc-object? any/c)]
  [nswindow-set-miniwindow-title! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-next-responder! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-parent-window! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-represented-filename! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-represented-url (c-> objc-object? any/c)]
  [nswindow-set-represented-url! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-restoration-class! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-subtitle! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-tabbing-identifier! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-title! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-titlebar-accessory-view-controllers! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-toolbar! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-touch-bar! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-undo-manager (c-> objc-object? any/c)]
  [nswindow-user-activity (c-> objc-object? any/c)]
  [nswindow-set-user-activity! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-window-controller! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-add-child-window-ordered! (c-> objc-object? (or/c string? objc-object? cpointer?) exact-nonnegative-integer? void?)]
  [nswindow-add-tabbed-window-ordered! (c-> objc-object? (or/c string? objc-object? cpointer?) exact-nonnegative-integer? void?)]
  [nswindow-add-titlebar-accessory-view-controller! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-begin-critical-sheet-completion-handler! (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c procedure? #f) void?)]
  [nswindow-begin-gesture-with-event! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-begin-sheet-completion-handler! (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c procedure? #f) void?)]
  ...
  [nswindow-change-mode-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-close! (c-> objc-object? void?)]
  [nswindow-constrain-frame-rect-to-screen (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nswindow-context-menu-key-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-cursor-update (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-data-with-eps-inside-rect (c-> objc-object? any/c any/c)]
  [nswindow-data-with-pdf-inside-rect (c-> objc-object? any/c any/c)]
  [nswindow-deminiaturize (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-end-editing-for! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-end-gesture-with-event! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-end-sheet! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-end-sheet-return-code! (c-> objc-object? (or/c string? objc-object? cpointer?) exact-integer? void?)]
  [nswindow-field-editor-for-object (c-> objc-object? boolean? (or/c string? objc-object? cpointer?) any/c)]
  [nswindow-flags-changed (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-flush-buffered-key-events (c-> objc-object? void?)]
  [nswindow-frame-rect-for-content-rect (c-> objc-object? any/c any/c)]
  [nswindow-help-requested (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-insert-titlebar-accessory-view-controller-at-index! (c-> objc-object? (or/c string? objc-object? cpointer?) exact-integer? void?)]
  [nswindow-interpret-key-events (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-key-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-key-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-magnify-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-make-first-responder (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nswindow-make-key-and-order-front (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-make-key-window (c-> objc-object? void?)]
  [nswindow-make-main-window (c-> objc-object? void?)]
  [nswindow-merge-all-windows (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-miniaturize (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-mouse-cancelled (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-mouse-entered (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-mouse-exited (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-mouse-moved (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-move-tab-to-new-window! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-no-responder-for (c-> objc-object? cpointer? void?)]
  [nswindow-order-back! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-order-front! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-order-front-regardless! (c-> objc-object? void?)]
  [nswindow-order-out! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-order-window-relative-to! (c-> objc-object? exact-nonnegative-integer? exact-integer? void?)]
  [nswindow-other-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-other-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-other-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-perform-close! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-perform-key-equivalent! (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nswindow-perform-miniaturize! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-perform-window-drag-with-event! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-perform-zoom! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-pressure-change-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-print (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-quick-look-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-recalculate-key-view-loop (c-> objc-object? void?)]
  [nswindow-remove-child-window! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-remove-titlebar-accessory-view-controller-at-index! (c-> objc-object? exact-integer? void?)]
  [nswindow-request-sharing-of-window-completion-handler (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c procedure? #f) void?)]
  [nswindow-request-sharing-of-window-using-preview-title-completion-handler (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) (or/c procedure? #f) void?)]
  ...
  [nswindow-right-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-right-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-right-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-rotate-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-run-toolbar-customization-palette (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-save-frame-using-name (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-scroll-wheel (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-select-key-view-following-view (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-select-key-view-preceding-view (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-select-next-key-view (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-select-next-tab (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-select-previous-key-view (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-select-previous-tab (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-set-frame-autosave-name! (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nswindow-set-frame-from-string! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-set-frame-origin! (c-> objc-object? any/c void?)]
  [nswindow-set-frame-top-left-point! (c-> objc-object? any/c void?)]
  [nswindow-set-frame-using-name! (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nswindow-set-frame-using-name-force! (c-> objc-object? (or/c string? objc-object? cpointer?) boolean? boolean?)]
  [nswindow-set-title-with-represented-filename! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-should-be-treated-as-ink-event (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nswindow-show-context-help (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-smart-magnify-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-standard-window-button (c-> objc-object? exact-nonnegative-integer? any/c)]
  [nswindow-supplemental-target-for-action-sender (c-> objc-object? cpointer? (or/c string? objc-object? cpointer?) any/c)]
  [nswindow-swipe-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-tablet-point (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-tablet-proximity (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-toggle-full-screen! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-toggle-tab-bar! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-toggle-tab-overview! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-toggle-toolbar-shown! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-touches-began-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-touches-cancelled-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-touches-ended-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-touches-moved-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nswindow-transfer-window-sharing-to-window-completion-handler (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c procedure? #f) void?)]
  [nswindow-try-to-perform-with (c-> objc-object? cpointer? (or/c string? objc-object? cpointer?) boolean?)]
  [nswindow-update (c-> objc-object? void?)]
  [nswindow-valid-requestor-for-send-type-return-type (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nswindow-zoom (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-min-frame-width-with-title-style-mask (c-> (or/c string? objc-object? cpointer?) exact-nonnegative-integer? real?)]
  [nswindow-remove-frame-using-name! (c-> (or/c string? objc-object? cpointer?) void?)]
  ...
  [nswindow-window-with-content-view-controller (c-> (or/c string? objc-object? cpointer?) any/c)]
  )

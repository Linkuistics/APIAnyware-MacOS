...
(provide/contract
  ...
  [nswindow-field-editor-for-object (c-> objc-object? boolean? (or/c string? objc-object? #f) any/c)]
...
(define (nswindow-no-responder-for self event-selector)
  (_msg-32 (coerce-arg self) (sel_registerName "noResponderFor:") (sel_registerName event-selector)))
...
(define (nswindow-supplemental-target-for-action-sender self action sender)
  (wrap-objc-object
   (_msg-34 (coerce-arg self) (sel_registerName "supplementalTargetForAction:sender:") (sel_registerName action) (coerce-arg sender))
   ))
...
(define (nswindow-try-to-perform-with self action object)
  (_msg-33 (coerce-arg self) (sel_registerName "tryToPerform:with:") (sel_registerName action) (coerce-arg object)))

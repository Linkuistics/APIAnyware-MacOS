...
(define _msg-5  ; (_fun _pointer _pointer _double -> _void)
  (get-ffi-obj "objc_msgSend" _objc-lib (_fun _pointer _pointer _double -> _void)))
(define _msg-6  ; (_fun _pointer _pointer _id -> _bool)
...
(define (nsmenu-set-allows-context-menu-plug-ins! self value)
  (_msg-4 (coerce-arg self) (sel_registerName "setAllowsContextMenuPlugIns:") value))
...
(define (nsmenu-set-autoenables-items! self value)
  (_msg-4 (coerce-arg self) (sel_registerName "setAutoenablesItems:") value))
...
(define (nsmenu-set-automatically-inserts-writing-tools-items! self value)
  (_msg-4 (coerce-arg self) (sel_registerName "setAutomaticallyInsertsWritingToolsItems:") value))
...
(define (nsmenu-set-menu-changed-messages-enabled! self value)
  (_msg-4 (coerce-arg self) (sel_registerName "setMenuChangedMessagesEnabled:") value))
(define (nsmenu-minimum-width self)
  (tell #:type _double (coerce-arg self) minimumWidth))
(define (nsmenu-set-minimum-width! self value)
  (_msg-5 (coerce-arg self) (sel_registerName "setMinimumWidth:") value))
...
(define (nsmenu-set-presentation-style! self value)
  (_msg-15 (coerce-arg self) (sel_registerName "setPresentationStyle:") value))
...
(define (nsmenu-set-selection-mode! self value)
  (_msg-15 (coerce-arg self) (sel_registerName "setSelectionMode:") value))
...
(define (nsmenu-set-shows-state-column! self value)
  (_msg-4 (coerce-arg self) (sel_registerName "setShowsStateColumn:") value))
...
(define (nsmenu-set-user-interface-layout-direction! self value)
  (_msg-15 (coerce-arg self) (sel_registerName "setUserInterfaceLayoutDirection:") value))
...
(define (nsmenu-add-item-with-title-action-key-equivalent! self string selector char-code)
  (wrap-objc-object
   (_msg-11 (coerce-arg self) (sel_registerName "addItemWithTitle:action:keyEquivalent:") (coerce-arg string) (sel_registerName selector) (coerce-arg char-code))
   ))
...
(define (nsmenu-index-of-item self item)
  (_msg-7 (coerce-arg self) (sel_registerName "indexOfItem:") (coerce-arg item)))
(define (nsmenu-index-of-item-with-represented-object self object)
  (_msg-7 (coerce-arg self) (sel_registerName "indexOfItemWithRepresentedObject:") (coerce-arg object)))
(define (nsmenu-index-of-item-with-submenu self submenu)
  (_msg-7 (coerce-arg self) (sel_registerName "indexOfItemWithSubmenu:") (coerce-arg submenu)))
(define (nsmenu-index-of-item-with-tag self tag)
  (_msg-14 (coerce-arg self) (sel_registerName "indexOfItemWithTag:") tag))
(define (nsmenu-index-of-item-with-target-and-action self target action-selector)
  (_msg-10 (coerce-arg self) (sel_registerName "indexOfItemWithTarget:andAction:") (coerce-arg target) (sel_registerName action-selector)))
(define (nsmenu-index-of-item-with-title self title)
  (_msg-7 (coerce-arg self) (sel_registerName "indexOfItemWithTitle:") (coerce-arg title)))
(define (nsmenu-insert-item-at-index! self new-item index)
  (_msg-9 (coerce-arg self) (sel_registerName "insertItem:atIndex:") (coerce-arg new-item) index))
(define (nsmenu-insert-item-with-title-action-key-equivalent-at-index! self string selector char-code index)
  (wrap-objc-object
   (_msg-12 (coerce-arg self) (sel_registerName "insertItemWithTitle:action:keyEquivalent:atIndex:") (coerce-arg string) (sel_registerName selector) (coerce-arg char-code) index)
   ))
(define (nsmenu-item-at-index self index)
  (wrap-objc-object
   (_msg-13 (coerce-arg self) (sel_registerName "itemAtIndex:") index)
   ))
...
(define (nsmenu-item-with-tag self tag)
  (wrap-objc-object
   (_msg-13 (coerce-arg self) (sel_registerName "itemWithTag:") tag)
   ))
...
(define (nsmenu-perform-action-for-item-at-index! self index)
  (_msg-15 (coerce-arg self) (sel_registerName "performActionForItemAtIndex:") index))
(define (nsmenu-perform-key-equivalent! self event)
  (_msg-6 (coerce-arg self) (sel_registerName "performKeyEquivalent:") (coerce-arg event)))
(define (nsmenu-pop-up-menu-positioning-item-at-location-in-view self item location view)
  (_msg-8 (coerce-arg self) (sel_registerName "popUpMenuPositioningItem:atLocation:inView:") (coerce-arg item) location (coerce-arg view)))
...
(define (nsmenu-remove-item-at-index! self index)
  (_msg-15 (coerce-arg self) (sel_registerName "removeItemAtIndex:") index))
...
(define (nsmenu-set-menu-bar-visible! visible)
  (_msg-4 NSMenu (sel_registerName "setMenuBarVisible:") visible))

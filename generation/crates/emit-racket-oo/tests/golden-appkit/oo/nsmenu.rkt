...
(provide NSMenu)
(provide/contract
  [make-nsmenu-init-with-coder (c-> any/c any/c)]
  [make-nsmenu-init-with-title (c-> any/c any/c)]
  ...
  [nsmenu-set-delegate! (c-> objc-object? any/c void?)]
  [nsmenu-font (c-> objc-object? any/c)]
  [nsmenu-set-font! (c-> objc-object? any/c void?)]
  [nsmenu-highlighted-item (c-> objc-object? any/c)]
  [nsmenu-item-array (c-> objc-object? any/c)]
  [nsmenu-set-item-array! (c-> objc-object? any/c void?)]
  ...
  [nsmenu-set-selected-items! (c-> objc-object? any/c void?)]
  ...
  [nsmenu-set-supermenu! (c-> objc-object? any/c void?)]
  [nsmenu-title (c-> objc-object? any/c)]
  [nsmenu-set-title! (c-> objc-object? any/c void?)]
  ...
  [nsmenu-add-item! (c-> objc-object? any/c void?)]
  [nsmenu-add-item-with-title-action-key-equivalent! (c-> objc-object? any/c cpointer? any/c any/c)]
  [nsmenu-cancel-tracking (c-> objc-object? void?)]
  [nsmenu-cancel-tracking-without-animation (c-> objc-object? void?)]
  [nsmenu-index-of-item (c-> objc-object? any/c exact-integer?)]
  [nsmenu-index-of-item-with-represented-object (c-> objc-object? any/c exact-integer?)]
  [nsmenu-index-of-item-with-submenu (c-> objc-object? any/c exact-integer?)]
  [nsmenu-index-of-item-with-tag (c-> objc-object? exact-integer? exact-integer?)]
  [nsmenu-index-of-item-with-target-and-action (c-> objc-object? any/c cpointer? exact-integer?)]
  [nsmenu-index-of-item-with-title (c-> objc-object? any/c exact-integer?)]
  [nsmenu-insert-item-at-index! (c-> objc-object? any/c exact-integer? void?)]
  [nsmenu-insert-item-with-title-action-key-equivalent-at-index! (c-> objc-object? any/c cpointer? any/c exact-integer? any/c)]
  [nsmenu-item-at-index (c-> objc-object? exact-integer? any/c)]
  [nsmenu-item-changed (c-> objc-object? any/c void?)]
  [nsmenu-item-with-tag (c-> objc-object? exact-integer? any/c)]
  [nsmenu-item-with-title (c-> objc-object? any/c any/c)]
  [nsmenu-perform-action-for-item-at-index! (c-> objc-object? exact-integer? void?)]
  [nsmenu-perform-key-equivalent! (c-> objc-object? any/c boolean?)]
  [nsmenu-pop-up-menu-positioning-item-at-location-in-view (c-> objc-object? any/c any/c any/c boolean?)]
  [nsmenu-remove-all-items! (c-> objc-object? void?)]
  [nsmenu-remove-item! (c-> objc-object? any/c void?)]
  [nsmenu-remove-item-at-index! (c-> objc-object? exact-integer? void?)]
  [nsmenu-set-submenu-for-item! (c-> objc-object? any/c any/c void?)]
  [nsmenu-update (c-> objc-object? void?)]
  [nsmenu-menu-bar-visible (c-> boolean?)]
  [nsmenu-pop-up-context-menu-with-event-for-view (c-> any/c any/c any/c void?)]
  [nsmenu-pop-up-context-menu-with-event-for-view-with-font (c-> any/c any/c any/c any/c void?)]

...
(provide/contract
  [make-nsapplication-init-with-coder (c-> any/c any/c)]
  ...
  [nsapplication-set-appearance! (c-> objc-object? any/c void?)]
  [nsapplication-application-icon-image (c-> objc-object? any/c)]
  [nsapplication-set-application-icon-image! (c-> objc-object? any/c void?)]
  ...
  [nsapplication-set-delegate! (c-> objc-object? any/c void?)]
  ...
  [nsapplication-set-help-menu! (c-> objc-object? any/c void?)]
  ...
  [nsapplication-set-windows-menu! (c-> objc-object? any/c void?)]
  ...
  [nsapplication-begin-gesture-with-event! (c-> objc-object? any/c void?)]
  [nsapplication-begin-modal-session-for-window! (c-> objc-object? any/c (or/c cpointer? #f))]
  [nsapplication-cancel-user-attention-request (c-> objc-object? exact-integer? void?)]
  [nsapplication-change-mode-with-event (c-> objc-object? any/c void?)]
  [nsapplication-context-menu-key-down (c-> objc-object? any/c void?)]
  [nsapplication-cursor-update (c-> objc-object? any/c void?)]
  [nsapplication-deactivate (c-> objc-object? void?)]
  [nsapplication-end-gesture-with-event! (c-> objc-object? any/c void?)]
  ...
  [nsapplication-flags-changed (c-> objc-object? any/c void?)]
  [nsapplication-flush-buffered-key-events (c-> objc-object? void?)]
  [nsapplication-help-requested (c-> objc-object? any/c void?)]
  [nsapplication-hide (c-> objc-object? any/c void?)]
  [nsapplication-hide-other-applications (c-> objc-object? any/c void?)]
  [nsapplication-interpret-key-events (c-> objc-object? any/c void?)]
  ...
  [nsapplication-key-down (c-> objc-object? any/c void?)]
  [nsapplication-key-up (c-> objc-object? any/c void?)]
  [nsapplication-magnify-with-event (c-> objc-object? any/c void?)]
  [nsapplication-mouse-cancelled (c-> objc-object? any/c void?)]
  [nsapplication-mouse-down (c-> objc-object? any/c void?)]
  [nsapplication-mouse-dragged (c-> objc-object? any/c void?)]
  [nsapplication-mouse-entered (c-> objc-object? any/c void?)]
  [nsapplication-mouse-exited (c-> objc-object? any/c void?)]
  [nsapplication-mouse-moved (c-> objc-object? any/c void?)]
  [nsapplication-mouse-up (c-> objc-object? any/c void?)]
  [nsapplication-no-responder-for (c-> objc-object? cpointer? void?)]
  [nsapplication-order-front-character-palette! (c-> objc-object? any/c void?)]
  [nsapplication-other-mouse-down (c-> objc-object? any/c void?)]
  [nsapplication-other-mouse-dragged (c-> objc-object? any/c void?)]
  [nsapplication-other-mouse-up (c-> objc-object? any/c void?)]
  [nsapplication-perform-key-equivalent! (c-> objc-object? any/c boolean?)]
  [nsapplication-pressure-change-with-event (c-> objc-object? any/c void?)]
  [nsapplication-prevent-window-ordering (c-> objc-object? void?)]
  [nsapplication-quick-look-with-event (c-> objc-object? any/c void?)]
  ...
  [nsapplication-report-exception (c-> objc-object? any/c void?)]
  ...
  [nsapplication-right-mouse-down (c-> objc-object? any/c void?)]
  [nsapplication-right-mouse-dragged (c-> objc-object? any/c void?)]
  [nsapplication-right-mouse-up (c-> objc-object? any/c void?)]
  [nsapplication-rotate-with-event (c-> objc-object? any/c void?)]
  [nsapplication-run (c-> objc-object? void?)]
  [nsapplication-run-modal-for-window (c-> objc-object? any/c exact-integer?)]
  [nsapplication-run-modal-session (c-> objc-object? (or/c cpointer? #f) exact-integer?)]
  [nsapplication-scroll-wheel (c-> objc-object? any/c void?)]
  ...
  [nsapplication-should-be-treated-as-ink-event (c-> objc-object? any/c boolean?)]
  [nsapplication-show-context-help (c-> objc-object? any/c void?)]
  [nsapplication-smart-magnify-with-event (c-> objc-object? any/c void?)]
  [nsapplication-stop (c-> objc-object? any/c void?)]
  [nsapplication-stop-modal (c-> objc-object? void?)]
  [nsapplication-stop-modal-with-code (c-> objc-object? exact-integer? void?)]
  [nsapplication-supplemental-target-for-action-sender (c-> objc-object? cpointer? any/c any/c)]
  [nsapplication-swipe-with-event (c-> objc-object? any/c void?)]
  [nsapplication-tablet-point (c-> objc-object? any/c void?)]
  [nsapplication-tablet-proximity (c-> objc-object? any/c void?)]
  [nsapplication-terminate (c-> objc-object? any/c void?)]
  [nsapplication-touches-began-with-event (c-> objc-object? any/c void?)]
  [nsapplication-touches-cancelled-with-event (c-> objc-object? any/c void?)]
  [nsapplication-touches-ended-with-event (c-> objc-object? any/c void?)]
  [nsapplication-touches-moved-with-event (c-> objc-object? any/c void?)]
  [nsapplication-try-to-perform-with (c-> objc-object? cpointer? any/c boolean?)]
  [nsapplication-unhide (c-> objc-object? any/c void?)]
  [nsapplication-unhide-all-applications (c-> objc-object? any/c void?)]
  [nsapplication-unhide-without-activation (c-> objc-object? void?)]
  [nsapplication-update-windows (c-> objc-object? void?)]
  [nsapplication-valid-requestor-for-send-type-return-type (c-> objc-object? any/c any/c any/c)]
  ...
  [nsapplication-yield-activation-to-application (c-> objc-object? any/c void?)]
  [nsapplication-yield-activation-to-application-with-bundle-identifier (c-> objc-object? any/c void?)]
  [nsapplication-detach-drawing-thread-to-target-with-object (c-> cpointer? any/c any/c void?)]

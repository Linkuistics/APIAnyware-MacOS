...
(provide/contract
  [make-nsapplication-init-with-coder (c-> (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nsapplication-set-appearance! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-application-icon-image (c-> objc-object? any/c)]
  [nsapplication-set-application-icon-image! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsapplication-set-delegate! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsapplication-set-help-menu! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsapplication-set-main-menu! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-main-window (c-> objc-object? any/c)]
  [nsapplication-menu (c-> objc-object? any/c)]
  [nsapplication-set-menu! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-modal-window (c-> objc-object? any/c)]
  [nsapplication-next-responder (c-> objc-object? any/c)]
  [nsapplication-set-next-responder! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsapplication-set-services-menu! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-services-provider (c-> objc-object? any/c)]
  [nsapplication-set-services-provider! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-shared-application (c-> any/c)]
  [nsapplication-touch-bar (c-> objc-object? any/c)]
  [nsapplication-set-touch-bar! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-undo-manager (c-> objc-object? any/c)]
  [nsapplication-user-activity (c-> objc-object? any/c)]
  [nsapplication-set-user-activity! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsapplication-set-windows-menu! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsapplication-begin-gesture-with-event! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-begin-modal-session-for-window! (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c cpointer? #f))]
  [nsapplication-cancel-user-attention-request (c-> objc-object? exact-integer? void?)]
  [nsapplication-change-mode-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-context-menu-key-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-cursor-update (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-deactivate (c-> objc-object? void?)]
  [nsapplication-end-gesture-with-event! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsapplication-flags-changed (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-flush-buffered-key-events (c-> objc-object? void?)]
  [nsapplication-help-requested (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-hide (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-hide-other-applications (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-interpret-key-events (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsapplication-key-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-key-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-magnify-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-mouse-cancelled (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-mouse-entered (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-mouse-exited (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-mouse-moved (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-no-responder-for (c-> objc-object? cpointer? void?)]
  [nsapplication-order-front-character-palette! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-other-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-other-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-other-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-perform-key-equivalent! (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nsapplication-pressure-change-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-prevent-window-ordering (c-> objc-object? void?)]
  [nsapplication-quick-look-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsapplication-report-exception (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsapplication-right-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-right-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-right-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-rotate-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-run (c-> objc-object? void?)]
  [nsapplication-run-modal-for-window (c-> objc-object? (or/c string? objc-object? cpointer?) exact-integer?)]
  [nsapplication-run-modal-session (c-> objc-object? (or/c cpointer? #f) exact-integer?)]
  [nsapplication-scroll-wheel (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nsapplication-should-be-treated-as-ink-event (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nsapplication-show-context-help (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-smart-magnify-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-stop (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-stop-modal (c-> objc-object? void?)]
  [nsapplication-stop-modal-with-code (c-> objc-object? exact-integer? void?)]
  [nsapplication-supplemental-target-for-action-sender (c-> objc-object? cpointer? (or/c string? objc-object? cpointer?) any/c)]
  [nsapplication-swipe-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-tablet-point (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-tablet-proximity (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-terminate (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-touches-began-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-touches-cancelled-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-touches-ended-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-touches-moved-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-try-to-perform-with (c-> objc-object? cpointer? (or/c string? objc-object? cpointer?) boolean?)]
  [nsapplication-unhide (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-unhide-all-applications (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-unhide-without-activation (c-> objc-object? void?)]
  [nsapplication-update-windows (c-> objc-object? void?)]
  [nsapplication-valid-requestor-for-send-type-return-type (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nsapplication-yield-activation-to-application (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-yield-activation-to-application-with-bundle-identifier (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nsapplication-detach-drawing-thread-to-target-with-object (c-> cpointer? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) void?)]
...
(define (nsapplication-no-responder-for self event-selector)
  (_msg-9 (coerce-arg self) (sel_registerName "noResponderFor:") event-selector))
...
(define (nsapplication-supplemental-target-for-action-sender self action sender)
  (wrap-objc-object
   (_msg-11 (coerce-arg self) (sel_registerName "supplementalTargetForAction:sender:") action (coerce-arg sender))
   ))
...
(define (nsapplication-try-to-perform-with self action object)
  (_msg-10 (coerce-arg self) (sel_registerName "tryToPerform:with:") action (coerce-arg object)))
...
(define (nsapplication-detach-drawing-thread-to-target-with-object selector target argument)
  (_msg-12 NSApplication (sel_registerName "detachDrawingThread:toTarget:withObject:") selector (coerce-arg target) (coerce-arg argument)))

...
(define (nsapplication-set-automatic-customize-touch-bar-menu-item-enabled! self value)
  (_msg-3 (coerce-arg self) (sel_registerName "setAutomaticCustomizeTouchBarMenuItemEnabled:") value))
...
(define (nsapplication-set-presentation-options! self value)
  (_msg-17 (coerce-arg self) (sel_registerName "setPresentationOptions:") value))
...
(define (nsapplication-activate-ignoring-other-apps self ignore-other-apps)
  (_msg-3 (coerce-arg self) (sel_registerName "activateIgnoringOtherApps:") ignore-other-apps))
...
(define (nsapplication-begin-modal-session-for-window! self window)
  (_msg-6 (coerce-arg self) (sel_registerName "beginModalSessionForWindow:") (coerce-arg window)))
(define (nsapplication-cancel-user-attention-request self request)
  (_msg-9 (coerce-arg self) (sel_registerName "cancelUserAttentionRequest:") request))
...
(define (nsapplication-end-modal-session! self session)
  (_msg-12 (coerce-arg self) (sel_registerName "endModalSession:") session))
(define (nsapplication-enumerate-windows-with-options-using-block self options block)
  ...
  (_msg-10 (coerce-arg self) (sel_registerName "enumerateWindowsWithOptions:usingBlock:") options _blk1))
...
(define (nsapplication-no-responder-for self event-selector)
  (_msg-12 (coerce-arg self) (sel_registerName "noResponderFor:") (sel_registerName event-selector)))
...
(define (nsapplication-perform-key-equivalent! self event)
  (_msg-4 (coerce-arg self) (sel_registerName "performKeyEquivalent:") (coerce-arg event)))
...
(define (nsapplication-reply-to-application-should-terminate self should-terminate)
  (_msg-3 (coerce-arg self) (sel_registerName "replyToApplicationShouldTerminate:") should-terminate))
(define (nsapplication-reply-to-open-or-print self reply)
  (_msg-17 (coerce-arg self) (sel_registerName "replyToOpenOrPrint:") reply))
...
(define (nsapplication-request-user-attention self request-type)
  (_msg-16 (coerce-arg self) (sel_registerName "requestUserAttention:") request-type))
...
(define (nsapplication-run-modal-for-window self window)
  (_msg-5 (coerce-arg self) (sel_registerName "runModalForWindow:") (coerce-arg window)))
(define (nsapplication-run-modal-session self session)
  (_msg-11 (coerce-arg self) (sel_registerName "runModalSession:") session))
...
(define (nsapplication-set-activation-policy! self activation-policy)
  (_msg-7 (coerce-arg self) (sel_registerName "setActivationPolicy:") activation-policy))
(define (nsapplication-set-windows-need-update! self need-update)
  (_msg-3 (coerce-arg self) (sel_registerName "setWindowsNeedUpdate:") need-update))
(define (nsapplication-should-be-treated-as-ink-event self event)
  (_msg-4 (coerce-arg self) (sel_registerName "shouldBeTreatedAsInkEvent:") (coerce-arg event)))
...
(define (nsapplication-stop-modal-with-code self return-code)
  (_msg-9 (coerce-arg self) (sel_registerName "stopModalWithCode:") return-code))
(define (nsapplication-supplemental-target-for-action-sender self action sender)
  (wrap-objc-object
   (_msg-14 (coerce-arg self) (sel_registerName "supplementalTargetForAction:sender:") (sel_registerName action) (coerce-arg sender))
   ))
...
(define (nsapplication-try-to-perform-with self action object)
  (_msg-13 (coerce-arg self) (sel_registerName "tryToPerform:with:") (sel_registerName action) (coerce-arg object)))
...
(define (nsapplication-wants-forwarded-scroll-events-for-axis self axis)
  (_msg-7 (coerce-arg self) (sel_registerName "wantsForwardedScrollEventsForAxis:") axis))
(define (nsapplication-wants-scroll-events-for-swipe-tracking-on-axis self axis)
  (_msg-7 (coerce-arg self) (sel_registerName "wantsScrollEventsForSwipeTrackingOnAxis:") axis))
(define (nsapplication-window-with-window-number self window-num)
  (wrap-objc-object
   (_msg-8 (coerce-arg self) (sel_registerName "windowWithWindowNumber:") window-num)
   ))
...
(define (nsapplication-detach-drawing-thread-to-target-with-object selector target argument)
  (_msg-15 NSApplication (sel_registerName "detachDrawingThread:toTarget:withObject:") (sel_registerName selector) (coerce-arg target) (coerce-arg argument)))

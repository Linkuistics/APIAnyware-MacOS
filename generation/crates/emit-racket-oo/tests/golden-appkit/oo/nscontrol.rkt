...
(provide/contract
  ...
  [nscontrol-ancestor-shared-with-view (c-> objc-object? (or/c string? objc-object? #f) any/c)]
  ...
  [nscontrol-menu-for-event (c-> objc-object? (or/c string? objc-object? #f) any/c)]
...
(define (nscontrol-set-action! self value)
  (_msg-35 (coerce-arg self) (sel_registerName "setAction:") (sel_registerName value)))
...
(define (nscontrol-send-action-to self action target)
  (_msg-36 (coerce-arg self) (sel_registerName "sendAction:to:") (sel_registerName action) (coerce-arg target)))

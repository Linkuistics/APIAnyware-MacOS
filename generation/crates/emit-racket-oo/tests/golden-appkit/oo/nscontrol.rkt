...
(provide NSControl)
(provide/contract
  [make-nscontrol-init-with-coder (c-> (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nscontrol-set-action! (c-> objc-object? cpointer? void?)]
  ...
  [nscontrol-attributed-string-value (c-> objc-object? any/c)]
  [nscontrol-set-attributed-string-value! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nscontrol-set-background-filters! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nscontrol-bottom-anchor (c-> objc-object? any/c)]
  ...
  [nscontrol-candidate-list-touch-bar-item (c-> objc-object? any/c)]
  [nscontrol-cell (c-> objc-object? any/c)]
  [nscontrol-set-cell! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-cell-class (c-> cpointer?)]
  [nscontrol-set-cell-class! (c-> cpointer? void?)]
  [nscontrol-center-x-anchor (c-> objc-object? any/c)]
  [nscontrol-center-y-anchor (c-> objc-object? any/c)]
  ...
  [nscontrol-compositing-filter (c-> objc-object? any/c)]
  [nscontrol-set-compositing-filter! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-constraints (c-> objc-object? any/c)]
  [nscontrol-content-filters (c-> objc-object? any/c)]
  [nscontrol-set-content-filters! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nscontrol-default-menu (c-> any/c)]
  ...
  [nscontrol-enclosing-menu-item (c-> objc-object? any/c)]
  [nscontrol-enclosing-scroll-view (c-> objc-object? any/c)]
  [nscontrol-first-baseline-anchor (c-> objc-object? any/c)]
  ...
  [nscontrol-focus-view (c-> any/c)]
  [nscontrol-font (c-> objc-object? any/c)]
  [nscontrol-set-font! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-formatter (c-> objc-object? any/c)]
  [nscontrol-set-formatter! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nscontrol-set-gesture-recognizers! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-has-ambiguous-layout (c-> objc-object? boolean?)]
  [nscontrol-height-adjust-limit (c-> objc-object? real?)]
  [nscontrol-height-anchor (c-> objc-object? any/c)]
  ...
  [nscontrol-input-context (c-> objc-object? any/c)]
  ...
  [nscontrol-last-baseline-anchor (c-> objc-object? any/c)]
  [nscontrol-last-baseline-offset-from-bottom (c-> objc-object? real?)]
  [nscontrol-layer (c-> objc-object? any/c)]
  [nscontrol-set-layer! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nscontrol-layout-margins-guide (c-> objc-object? any/c)]
  [nscontrol-leading-anchor (c-> objc-object? any/c)]
  [nscontrol-left-anchor (c-> objc-object? any/c)]
  ...
  [nscontrol-menu (c-> objc-object? any/c)]
  [nscontrol-set-menu! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nscontrol-next-key-view (c-> objc-object? any/c)]
  [nscontrol-set-next-key-view! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-next-responder (c-> objc-object? any/c)]
  [nscontrol-set-next-responder! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-next-valid-key-view (c-> objc-object? any/c)]
  [nscontrol-object-value (c-> objc-object? any/c)]
  [nscontrol-set-object-value! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-opaque (c-> objc-object? boolean?)]
  [nscontrol-opaque-ancestor (c-> objc-object? any/c)]
  [nscontrol-page-footer (c-> objc-object? any/c)]
  [nscontrol-page-header (c-> objc-object? any/c)]
  ...
  [nscontrol-pressure-configuration (c-> objc-object? any/c)]
  [nscontrol-set-pressure-configuration! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-previous-key-view (c-> objc-object? any/c)]
  [nscontrol-previous-valid-key-view (c-> objc-object? any/c)]
  [nscontrol-print-job-title (c-> objc-object? any/c)]
  ...
  [nscontrol-right-anchor (c-> objc-object? any/c)]
  ...
  [nscontrol-safe-area-layout-guide (c-> objc-object? any/c)]
  [nscontrol-safe-area-rect (c-> objc-object? any/c)]
  [nscontrol-shadow (c-> objc-object? any/c)]
  [nscontrol-set-shadow! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-string-value (c-> objc-object? any/c)]
  [nscontrol-set-string-value! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-subviews (c-> objc-object? any/c)]
  [nscontrol-set-subviews! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-superview (c-> objc-object? any/c)]
  ...
  [nscontrol-set-target! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-tool-tip (c-> objc-object? any/c)]
  [nscontrol-set-tool-tip! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-top-anchor (c-> objc-object? any/c)]
  [nscontrol-touch-bar (c-> objc-object? any/c)]
  [nscontrol-set-touch-bar! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-tracking-areas (c-> objc-object? any/c)]
  [nscontrol-trailing-anchor (c-> objc-object? any/c)]
  ...
  [nscontrol-undo-manager (c-> objc-object? any/c)]
  [nscontrol-user-activity (c-> objc-object? any/c)]
  [nscontrol-set-user-activity! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nscontrol-width-anchor (c-> objc-object? any/c)]
  [nscontrol-window (c-> objc-object? any/c)]
  [nscontrol-writing-tools-coordinator (c-> objc-object? any/c)]
  [nscontrol-set-writing-tools-coordinator! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-accepts-first-mouse (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nscontrol-add-subview! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-add-subview-positioned-relative-to! (c-> objc-object? (or/c string? objc-object? cpointer?) exact-nonnegative-integer? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-add-tool-tip-rect-owner-user-data! (c-> objc-object? any/c (or/c string? objc-object? cpointer?) (or/c cpointer? #f) exact-integer?)]
  [nscontrol-adjust-scroll (c-> objc-object? any/c any/c)]
  [nscontrol-ancestor-shared-with-view (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  [nscontrol-autoscroll (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  ...
  [nscontrol-begin-gesture-with-event! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-bitmap-image-rep-for-caching-display-in-rect (c-> objc-object? any/c any/c)]
  [nscontrol-cache-display-in-rect-to-bitmap-image-rep (c-> objc-object? any/c (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-center-scan-rect! (c-> objc-object? any/c any/c)]
  [nscontrol-change-mode-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-context-menu-key-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-convert-point-from-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  [nscontrol-convert-point-to-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nscontrol-convert-rect-from-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  [nscontrol-convert-rect-to-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nscontrol-convert-size-from-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  [nscontrol-convert-size-to-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nscontrol-cursor-update (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-did-add-subview (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-did-close-menu-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) void?)]
  ...
  [nscontrol-display-rect-ignoring-opacity-in-context! (c-> objc-object? any/c (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-draw-rect (c-> objc-object? any/c void?)]
  [nscontrol-draw-with-expansion-frame-in-view (c-> objc-object? any/c (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-end-gesture-with-event! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-expansion-frame-with-frame (c-> objc-object? any/c any/c)]
  [nscontrol-flags-changed (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nscontrol-help-requested (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-hit-test (c-> objc-object? any/c any/c)]
  [nscontrol-interpret-key-events (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-is-continuous (c-> objc-object? boolean?)]
  [nscontrol-is-descendant-of (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  ...
  [nscontrol-key-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-key-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-layout (c-> objc-object? void?)]
  [nscontrol-layout-subtree-if-needed (c-> objc-object? void?)]
  [nscontrol-magnify-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-make-backing-layer (c-> objc-object? any/c)]
  [nscontrol-menu-for-event (c-> objc-object? (or/c string? objc-object? cpointer?) any/c)]
  [nscontrol-mouse-in-rect (c-> objc-object? any/c any/c boolean?)]
  [nscontrol-mouse-cancelled (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-mouse-entered (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-mouse-exited (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-mouse-moved (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-needs-to-draw-rect (c-> objc-object? any/c boolean?)]
  [nscontrol-no-responder-for (c-> objc-object? cpointer? void?)]
  [nscontrol-other-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-other-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-other-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-perform-click! (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-perform-key-equivalent! (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nscontrol-prepare-content-in-rect (c-> objc-object? any/c void?)]
  [nscontrol-prepare-for-reuse (c-> objc-object? void?)]
  [nscontrol-pressure-change-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-quick-look-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nscontrol-replace-subview-with! (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) void?)]
  ...
  [nscontrol-right-mouse-down (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-right-mouse-dragged (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-right-mouse-up (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-rotate-by-angle (c-> objc-object? real? void?)]
  [nscontrol-rotate-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nscontrol-scroll-wheel (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-send-action-to (c-> objc-object? cpointer? (or/c string? objc-object? cpointer?) boolean?)]
  ...
  [nscontrol-should-be-treated-as-ink-event (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nscontrol-should-delay-window-ordering-for-event (c-> objc-object? (or/c string? objc-object? cpointer?) boolean?)]
  [nscontrol-show-context-help (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-size-that-fits (c-> objc-object? any/c any/c)]
  [nscontrol-size-to-fit (c-> objc-object? void?)]
  [nscontrol-smart-magnify-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-sort-subviews-using-function-context (c-> objc-object? (or/c cpointer? #f) (or/c cpointer? #f) void?)]
  [nscontrol-supplemental-target-for-action-sender (c-> objc-object? cpointer? (or/c string? objc-object? cpointer?) any/c)]
  [nscontrol-swipe-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-tablet-point (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-tablet-proximity (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-take-double-value-from (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-take-float-value-from (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-take-int-value-from (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-take-integer-value-from (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-take-object-value-from (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-take-string-value-from (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-touches-began-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-touches-cancelled-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-touches-ended-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-touches-moved-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nscontrol-try-to-perform-with (c-> objc-object? cpointer? (or/c string? objc-object? cpointer?) boolean?)]
  [nscontrol-update-layer (c-> objc-object? void?)]
  [nscontrol-valid-requestor-for-send-type-return-type (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) any/c)]
  ...
  [nscontrol-view-will-move-to-superview (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-view-will-move-to-window (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
  ...
  [nscontrol-will-open-menu-with-event (c-> objc-object? (or/c string? objc-object? cpointer?) (or/c string? objc-object? cpointer?) void?)]
  [nscontrol-will-remove-subview (c-> objc-object? (or/c string? objc-object? cpointer?) void?)]
...
(define (nscontrol-set-cell-class! value)
  (_msg-35 NSControl (sel_registerName "setCellClass:") value))

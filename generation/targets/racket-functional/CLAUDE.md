...
Racket functional bindings using plain procedures and explicit objc_msgSend calls.

**Status:** Stub — not yet implemented. See `racket-oo` for the working OO target.
